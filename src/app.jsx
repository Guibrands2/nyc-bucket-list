...
const CAT_META = {
  "Museus":          { color: "#2563eb", light: "#dbeafe" },
  "Monumentos":      { color: "#7c3aed", light: "#ede9fe" },
  "Observatorios":   { color: "#ea7215", light: "#ffedd5" },
  "Natureza":        { color: "#16a34a", light: "#dcfce7" },
  "Livrarias":       { color: "#ca8a04", light: "#fef9c3" },
  "Lojas":           { color: "#db2777", light: "#fce7f3" },
  "Entretenimento":  { color: "#9333ea", light: "#f3e8ff" },
  "Compras":         { color: "#0891b2", light: "#cffafe" },
  "Bairros":         { color: "#dc2626", light: "#fee2e2" },
  "Comida":          { color: "#d97706", light: "#fef3c7" },
  "Dispensaries":    { color: "#15803d", light: "#dcfce7" },
  "Daytrips":        { color: "#0369a1", light: "#e0f2fe" },
};

const S = {
  bg: "#0f0f13", card: "#1a1a22", cardHover: "#20202a",
  border: "#2a2a38", text: "#f0eeff", textSub: "#9090b0", textDim: "#50506a",
  accent: "#ff3366", green: "#00e676", yellow: "#ffd600",
};

const INITIAL_PLACES = [
  { id: "t001", category: "Museus", name: "NY Transit Museum", emoji: "🚇", desc: "Museu dentro de uma estacao de metro desativada em Brooklyn Heights, com vagoes vintage.", price: "$", lat: 40.6906, lng: -73.9899, time: "2h", link: "https://www.nytransitmuseum.org", petFriendly: false, publicBathroom: true, rep: "Altamente recomendado, especialmente para fas de historia urbana e transporte." },
  { id: "t002", category: "Museus", name: "American Museum of Natural History", emoji: "🦕", desc: "O museu do Uma Noite no Museu: dinossauros, baleia azul gigante, planetario.", price: "$$", lat: 40.7813, lng: -73.9740, time: "dia inteiro", link: "https://www.amnh.org", petFriendly: false, publicBathroom: true, rep: "Um dos melhores museus do mundo. Reserve pelo menos 4h." },
  { id: "t003", category: "Museus", name: "MoMA", emoji: "🎨", desc: "Arte moderna e contemporanea. Van Gogh, Picasso, Dali, Warhol.", price: "$$", lat: 40.7614, lng: -73.9776, time: "3h+", link: "https://www.moma.org", petFriendly: false, publicBathroom: true, rep: "Colecao incrivel. Sextas a noite tem entrada gratuita em alguns periodos." },
  { id: "t004", category: "Museus", name: "9/11 Memorial & Museum", emoji: "🕊️", desc: "No local exato das Torres Gemeas. Depoimentos de sobreviventes e familias.", price: "$$", lat: 40.7115, lng: -74.0134, time: "3h+", link: "https://www.911memorial.org", petFriendly: false, publicBathroom: true, rep: "Experiencia profunda e necessaria. Reserve ingressos com antecedencia." },
  { id: "t005", category: "Museus", name: "Intrepid Museum", emoji: "✈️", desc: "Porta-avioes real ancorado no Hudson River com o onibus espacial Enterprise e o Concorde.", price: "$$", lat: 40.7645, lng: -74.0017, time: "3h+", link: "https://www.intrepidmuseum.org", petFriendly: false, publicBathroom: true, rep: "Unico e espetacular. O Concorde e o Enterprise valem o ingresso sozinhos." },
  { id: "t006", category: "Museus", name: "Building 92 / Brooklyn Navy Yard", emoji: "⚓", desc: "Centro de visitantes gratuito com 200 anos de historia do estaleiro naval.", price: "gratis", lat: 40.6990, lng: -73.9718, time: "1h", link: "https://brooklynnavyyard.org", petFriendly: false, publicBathroom: true, rep: "Joia escondida de Brooklyn. Gratuito e muito interessante." },
  { id: "t007", category: "Museus", name: "Museum of Broadway", emoji: "🎭", desc: "Tres andares com figurinos e aderecos originais de Hamilton, Phantom, Rent e Wicked.", price: "$$", lat: 40.7580, lng: -73.9855, time: "2h", link: "https://www.themuseumofbroadway.com", petFriendly: false, publicBathroom: true, rep: "Essencial para fas de musicais. Interativo e muito bem curado." },
  { id: "t008", category: "Monumentos", name: "NY Public Library", emoji: "📚", desc: "A biblioteca dos leoes, classica de filme. A sala de leitura principal e de cair o queixo.", price: "gratis", lat: 40.7532, lng: -73.9822, time: "1h", link: "https://www.nypl.org", petFriendly: false, publicBathroom: true, rep: "Arquitetura deslumbrante. Gratis e no coracao do Midtown." },
  { id: "t009", category: "Monumentos", name: "St. Patrick's Cathedral", emoji: "⛪", desc: "Catedral neogotica no meio da 5th Ave, impressionante por dentro com os vitrais.", price: "gratis", lat: 40.7586, lng: -73.9762, time: "30min", petFriendly: false, publicBathroom: false, rep: "A luz pelos vitrais e cinematografica. Silencioso e gratuito." },
  { id: "t010", category: "Monumentos", name: "NYSE + Charging Bull", emoji: "🐂", desc: "Fachada neoclassica da bolsa na Wall Street e o touro de bronze iconico do FiDi.", price: "gratis", lat: 40.7069, lng: -74.0089, time: "30min", petFriendly: true, publicBathroom: false, rep: "Classico de NYC. Vale a visita ao FiDi ao redor." },
  { id: "t011", category: "Monumentos", name: "Brooklyn Heights Promenade", emoji: "🌆", desc: "Calcadao suspenso com vista panoramica da skyline. Mais tranquilo que a ponte.", price: "gratis", lat: 40.6962, lng: -73.9991, time: "1h", petFriendly: true, publicBathroom: false, rep: "A melhor vista de Manhattan. Muito menos turista que a Brooklyn Bridge." },
  { id: "t012", category: "Monumentos", name: "Central Park (norte e leste)", emoji: "🌳", desc: "Bethesda Fountain, The Ramble, Belvedere Castle, Reservoir e Conservatory Garden.", price: "gratis", lat: 40.7812, lng: -73.9665, time: "3h+", petFriendly: true, publicBathroom: true, rep: "A parte menos turistica do parque. The Ramble e incrivel para birdwatching." },
  { id: "t013", category: "Observatorios", name: "SUMMIT One Vanderbilt", emoji: "🔮", desc: "Instalacoes de arte com espelhos e vidro, vistas deslumbrantes. Abre ate meia-noite.", price: "$$$", lat: 40.7527, lng: -73.9772, time: "2h", link: "https://summitov.com", petFriendly: false, publicBathroom: true, rep: "O mais impressionante dos observatorios. As instalacoes de arte elevam a experiencia." },
  { id: "t014", category: "Observatorios", name: "Top of the Rock", emoji: "🏙️", desc: "No Rockefeller Center, com a view classica com o Empire State no meio da foto.", price: "$$$", lat: 40.7593, lng: -73.9787, time: "1h", link: "https://www.topoftherocknyc.com", petFriendly: false, publicBathroom: true, rep: "A view mais iconica de NYC. Va no por do sol para ver a cidade acender." },
  { id: "t015", category: "Observatorios", name: "Empire State Building", emoji: "🌃", desc: "O icone absoluto de Nova York. Abre ate 11:30pm, otimo pra ir ao anoitecer.", price: "$$$", lat: 40.7484, lng: -73.9857, time: "2h", link: "https://www.esbnyc.com", petFriendly: false, publicBathroom: true, rep: "O classico dos classicos. A noite e magico. Reserve online." },
  { id: "t016", category: "Observatorios", name: "The Edge", emoji: "🫧", desc: "Terraco de vidro em Hudson Yards que parece que voce ta voando sobre a cidade.", price: "$$$", lat: 40.7534, lng: -74.0010, time: "1h", link: "https://edgenyc.com", petFriendly: false, publicBathroom: true, rep: "O mais moderno e ousado. O piso de vidro da um frio na barriga incrivel." },
  { id: "t017", category: "Observatorios", name: "One World Observatory", emoji: "🌍", desc: "No topo do World Trade Center, o predio mais alto do hemisferio ocidental.", price: "$$$", lat: 40.7130, lng: -74.0134, time: "1h", link: "https://www.oneworldobservatory.com", petFriendly: false, publicBathroom: true, rep: "Vista para o Downtown e Hudson River. A ascensao em si ja e uma experiencia." },
  { id: "t018", category: "Natureza", name: "Prospect Park", emoji: "🌿", desc: "O grande parque de Brooklyn, projetado pelos mesmos criadores do Central Park.", price: "gratis", lat: 40.6602, lng: -73.9690, time: "3h+", petFriendly: true, publicBathroom: true, rep: "Melhor que o Central Park para os moradores. Menos turista, mais genuino." },
  { id: "t019", category: "Natureza", name: "Bronx Zoo", emoji: "🦁", desc: "Um dos maiores zoologicos urbanos do mundo, no Bronx. Reserve o dia inteiro.", price: "$$", lat: 40.8506, lng: -73.8770, time: "dia inteiro", link: "https://bronxzoo.com", petFriendly: false, publicBathroom: true, rep: "Enorme e incrivel. Separe o dia inteiro. As especies raras sao um privilegio." },
  { id: "t020", category: "Natureza", name: "Coney Island", emoji: "🎡", desc: "Praia iconica com o parque Luna Park e o cachorro-quente do Nathan's Famous.", price: "$", lat: 40.5755, lng: -73.9707, time: "dia inteiro", petFriendly: true, publicBathroom: true, rep: "Nostalgia pura. Melhor no verao. O Nathan's Famous e uma instituicao americana." },
  { id: "t021", category: "Livrarias", name: "The Strand", emoji: "📖", desc: "4 andares e 18 milhas de livros na Union Square. Uma das livrarias mais famosas dos EUA.", price: "$", lat: 40.7330, lng: -73.9910, time: "1h", link: "https://www.strandbooks.com", petFriendly: false, publicBathroom: false, rep: "Uma das livrarias mais famosas do mundo. Os carrinhos de $1 na calçada sao imperdíveis." },
  { id: "t022", category: "Livrarias", name: "The Ripped Bodice", emoji: "💘", desc: "Livraria especializada em romance em Park Slope, Brooklyn.", price: "$", lat: 40.6761, lng: -73.9810, time: "1h", link: "https://www.therippedbodicebklyn.com", petFriendly: false, publicBathroom: false, rep: "Joia de Park Slope. Selecao curada de romance, equipe apaixonada." },
  { id: "t023", category: "Lojas", name: "Nintendo NY", emoji: "🎮", desc: "No Rockefeller Plaza, com merchandise exclusivo e demos de jogos.", price: "$", lat: 40.7582, lng: -73.9796, time: "1h", petFriendly: false, publicBathroom: false, rep: "Paraiso para gamers. Exclusivos que nao encontra em outro lugar." },
  { id: "t024", category: "Lojas", name: "Disney Store", emoji: "✨", desc: "Na area da Times Square, dois andares de tudo que e Disney, Marvel e Pixar.", price: "$", lat: 40.7574, lng: -73.9857, time: "1h", petFriendly: false, publicBathroom: false, rep: "Maior Disney Store do mundo. Magica para criancas e adultos nostalgicos." },
  { id: "t025", category: "Lojas", name: "Hershey's + M&M + Lego", emoji: "🍫", desc: "As tres gigantes na Times Square. Visuais, caoticas e divertidas.", price: "$", lat: 40.7580, lng: -73.9845, time: "1h", petFriendly: false, publicBathroom: false, rep: "Mais pela experiencia visual que pelas compras. Muito caotico mas iconico." },
  { id: "t026", category: "Entretenimento", name: "SPYSCAPE", emoji: "🕵️", desc: "Museu interativo de espionagem: quebra codigos e descobre seu perfil de espiao.", price: "$$", lat: 40.7634, lng: -73.9863, time: "2h", link: "https://spyscape.com", petFriendly: false, publicBathroom: true, rep: "Super interativo e surpreendente. Otimo para casais." },
  { id: "t027", category: "Entretenimento", name: "Show no Madison Square Garden", emoji: "🎸", desc: "O maior e mais famoso venue indoor de NY.", price: "$$$", lat: 40.7505, lng: -73.9934, time: "3h+", link: "https://www.msg.com", petFriendly: false, publicBathroom: true, rep: "O Garden e uma lenda. Mesmo shows mediocres ficam epicos dentro dele." },
  { id: "t028", category: "Entretenimento", name: "PARAISO (Westlight Rooftop)", emoji: "🌅", desc: "Festa semanal aos domingos no rooftop do William Vale, Williamsburg.", price: "$$", lat: 40.7181, lng: -73.9566, time: "3h+", link: "https://www.paraisonyc.com", petFriendly: false, publicBathroom: true, rep: "Um dos melhores rooftops de NYC. Musica, drinks e vista incrivel." },
  { id: "t029", category: "Entretenimento", name: "Paradise Sunset NYC", emoji: "🌇", desc: "Day party de rooftop animada. Proximo evento em junho.", price: "$$", lat: 40.7549, lng: -73.9840, time: "3h+", petFriendly: false, publicBathroom: true, rep: "Festas animadas com vista incrivel da cidade." },
  { id: "t030", category: "Entretenimento", name: "Ellen's Stardust Diner", emoji: "🎤", desc: "Restaurante dos garcons que cantam na Broadway, tematico dos anos 50.", price: "$$", lat: 40.7614, lng: -73.9848, time: "2h", link: "https://www.ellensstardustdiner.com", petFriendly: false, publicBathroom: true, rep: "Experiencia unica em NYC. Garcons cantores talentosíssimos. Fila mas vale." },
  { id: "t031", category: "Entretenimento", name: "Bares Speakeasy", emoji: "🥃", desc: "Bares secretos escondidos atras de cafeterias e cabines telefonicas.", price: "$$", lat: 40.7282, lng: -74.0076, time: "2h", petFriendly: false, publicBathroom: true, rep: "PDT e Please Don't Tell sao os mais famosos. Reserve com antecedencia." },
  { id: "t032", category: "Comida", name: "Joe's Pizza", emoji: "🍕", desc: "A fatia de pizza mais classica de NY desde 1975. Original no West Village.", price: "$", lat: 40.7306, lng: -74.0022, time: "30min", link: "https://www.joespizzanyc.com", petFriendly: false, publicBathroom: false, rep: "A pizza perfeita de NYC. Simples, classica e deliciosa." },
  { id: "t033", category: "Compras", name: "American Dream Outlet", emoji: "🛍️", desc: "O maior outlet de NJ com parque de diversoes, pista de esqui indoor e aquario.", price: "$$", lat: 40.8135, lng: -74.0669, time: "dia inteiro", link: "https://www.americandream.com", petFriendly: false, publicBathroom: true, rep: "Muito alem de um outlet. O parque de diversoes indoor vale a visita." },
  { id: "s001", category: "Bairros", name: "Governors Island", emoji: "⛵", desc: "Ilha sem carros na baia com arte, piquenique e vista pro Downtown.", price: "gratis", lat: 40.6895, lng: -74.0165, time: "3h+", link: "https://govisland.com", petFriendly: true, publicBathroom: true, rep: "Esconderijo perfeito no verao. Bicicletas, hammocks, arte e nenhum carro." },
  { id: "s002", category: "Bairros", name: "Roosevelt Island", emoji: "🌉", desc: "Ilhinha no East River com tramway iconico saindo da 2nd Ave.", price: "gratis", lat: 40.7614, lng: -73.9506, time: "2h", petFriendly: true, publicBathroom: false, rep: "Muito subestimado. O tramway e uma experiencia unica." },
  { id: "s003", category: "Bairros", name: "Harlem", emoji: "🎷", desc: "Berco do jazz e da cultura negra americana. Gospel, soul food e murais incriveis.", price: "$", lat: 40.8116, lng: -73.9465, time: "3h+", petFriendly: true, publicBathroom: false, rep: "Visita cultural essencial. O gospel de domingo no Abyssinian Baptist Church e transformador." },
  { id: "s004", category: "Bairros", name: "Astoria, Queens", emoji: "🇬🇷", desc: "Bairro grego com otimos restaurantes, museu de cinema e atmosfera europeia.", price: "$", lat: 40.7721, lng: -73.9302, time: "3h+", petFriendly: true, publicBathroom: false, rep: "A melhor comida grega fora da Grecia. Museum of the Moving Image imperdivel." },
  { id: "s005", category: "Bairros", name: "Flushing, Queens", emoji: "🥟", desc: "A melhor gastronomia asiatica fora da Asia. Chinatown gigante com dim sum.", price: "$", lat: 40.7675, lng: -73.8330, time: "3h+", petFriendly: false, publicBathroom: true, rep: "Para os amantes de comida asiatica e um paraiso. Dim sum irresistivel." },
  { id: "s006", category: "Bairros", name: "Little Italy & Chinatown", emoji: "🍝", desc: "Dois bairros historicos em Lower Manhattan. Cannoli, dumplings e historia.", price: "$", lat: 40.7188, lng: -73.9973, time: "2h", petFriendly: true, publicBathroom: false, rep: "Little Italy e pequena mas charmosa. Chinatown e enorme e autentica." },
  { id: "s007", category: "Bairros", name: "The High Line", emoji: "🌿", desc: "Parque linear suspenso numa ferrovia desativada no West Side.", price: "gratis", lat: 40.7480, lng: -74.0048, time: "2h", link: "https://www.thehighline.org", petFriendly: true, publicBathroom: true, rep: "Um dos melhores projetos urbanos do seculo. Arte, jardins e vistas unicas." },
  { id: "s008", category: "Bairros", name: "Greenpoint, Brooklyn", emoji: "🇵🇱", desc: "Bairro polones com cafes independentes, galerias e vista da skyline.", price: "$", lat: 40.7242, lng: -73.9480, time: "2h", petFriendly: true, publicBathroom: false, rep: "O bairro mais charmoso de Brooklyn. Cafes incriveis e atmosfera tranquila." },
  { id: "s009", category: "Bairros", name: "Red Hook, Brooklyn", emoji: "⚓", desc: "Antigo bairro industrial na beira d'agua com galerias e cervejarias.", price: "$", lat: 40.6759, lng: -74.0109, time: "2h", petFriendly: true, publicBathroom: false, rep: "Off the beaten path mas vale muito. Steve's Key Lime Pie e obrigatorio." },
  { id: "s010", category: "Bairros", name: "Jackson Heights, Queens", emoji: "🇮🇳", desc: "Bairro mais diverso do mundo. Culinaria sul-asiatica, latina e muito mais.", price: "$", lat: 40.7498, lng: -73.8831, time: "2h", petFriendly: true, publicBathroom: false, rep: "Uma volta ao mundo em alguns quarteiroes. Biryanis e samosas incriveis." },
  { id: "s011", category: "Museus", name: "Whitney Museum", emoji: "🎨", desc: "Arte americana contemporanea no Meatpacking District com terraco incrivel.", price: "$$", lat: 40.7396, lng: -74.0089, time: "2h", link: "https://whitney.org", petFriendly: false, publicBathroom: true, rep: "Colecao americana extraordinaria. O terraco com vista pro Hudson e bonus." },
  { id: "s012", category: "Museus", name: "The Met", emoji: "🏛️", desc: "Um dos maiores museus do mundo. Egito, armaduras medievais, impressionismo.", price: "$$", lat: 40.7794, lng: -73.9632, time: "dia inteiro", link: "https://www.metmuseum.org", petFriendly: false, publicBathroom: true, rep: "Poderia passar uma semana e nao ver tudo. Um dos 3 maiores museus do mundo." },
  { id: "s013", category: "Museus", name: "Guggenheim", emoji: "🌀", desc: "O predio em espiral de Frank Lloyd Wright ja e arte. Colecao de arte moderna.", price: "$$", lat: 40.7830, lng: -73.9590, time: "2h", link: "https://www.guggenheim.org", petFriendly: false, publicBathroom: true, rep: "O edificio sozinho ja justifica a visita. Arquitetura e obra de arte em si." },
  { id: "s014", category: "Museus", name: "Museum of the City of NY", emoji: "🗽", desc: "A historia completa de Nova York do seculo XVII ate hoje.", price: "$", lat: 40.7920, lng: -73.9519, time: "2h", link: "https://mcny.org", petFriendly: false, publicBathroom: true, rep: "Para quem quer entender NYC fundo. Exposicoes temporarias sempre excelentes." },
  { id: "s015", category: "Museus", name: "New York Hall of Science", emoji: "🔬", desc: "Museu de ciencias interativo em Queens com playground cientifico ao ar livre.", price: "$", lat: 40.7467, lng: -73.8467, time: "3h+", link: "https://nysci.org", petFriendly: false, publicBathroom: true, rep: "Subestimado e incrivel. O playground cientifico ao ar livre e unico no mundo." },
  { id: "s016", category: "Museus", name: "Tenement Museum", emoji: "🏚️", desc: "Visita guiada a apartamentos de imigrantes preservados do seculo XIX.", price: "$$", lat: 40.7183, lng: -73.9898, time: "2h", link: "https://www.tenement.org", petFriendly: false, publicBathroom: false, rep: "Uma das experiencias mais tocantes de NYC. A historia dos imigrantes ganha vida." },
  { id: "s017", category: "Museus", name: "Brooklyn Museum", emoji: "🖼️", desc: "Segundo maior museu de arte dos EUA com colecao egipcia impressionante.", price: "$$", lat: 40.6712, lng: -73.9636, time: "3h+", link: "https://www.brooklynmuseum.org", petFriendly: false, publicBathroom: true, rep: "Incrivelmente subestimado. A colecao egipcia rivaliza com o Met. Sem filas." },
  { id: "s018", category: "Museus", name: "Frick Collection", emoji: "🎻", desc: "Mansao do seculo XIX transformada em museu com Vermeer, Rembrandt e Renoir.", price: "$$", lat: 40.7713, lng: -73.9672, time: "2h", link: "https://www.frick.org", petFriendly: false, publicBathroom: true, rep: "Experiencia unica de ver arte numa mansao. Intimista e absolutamente elegante." },
  { id: "s019", category: "Comida", name: "Smorgasburg", emoji: "🍜", desc: "Maior mercado de comida ao ar livre dos EUA, todo sabado em Williamsburg.", price: "$", lat: 40.7223, lng: -73.9572, time: "2h", link: "https://www.smorgasburg.com", petFriendly: true, publicBathroom: true, rep: "O melhor mercado de comida dos EUA. Chega cedo e leva cash." },
  { id: "s020", category: "Comida", name: "Chelsea Market", emoji: "🥐", desc: "Mercado gourmet coberto numa antiga fabrica de biscoitos.", price: "$$", lat: 40.7424, lng: -74.0048, time: "2h", link: "https://www.chelseamarket.com", petFriendly: false, publicBathroom: true, rep: "Perfeito para almocar. A Lobster Place e Los Tacos No. 1 sao obrigatorios." },
  { id: "s021", category: "Comida", name: "Katz's Delicatessen", emoji: "🥪", desc: "O deli mais famoso de NY, desde 1888. O sanduiche de pastrami e lendario.", price: "$$", lat: 40.7223, lng: -73.9874, time: "1h", link: "https://katzsdelicatessen.com", petFriendly: false, publicBathroom: true, rep: "Uma instituicao. O pastrami e transcendental. Caro mas vale cada centavo." },
  { id: "s022", category: "Comida", name: "Di Fara Pizza", emoji: "🍕", desc: "A pizza mais famosa de Brooklyn, feita a mao pelo mesmo dono ha decadas.", price: "$", lat: 40.6249, lng: -73.9612, time: "1h", petFriendly: false, publicBathroom: false, rep: "Peregrinacao obrigatoria para fas de pizza. Fila longa mas pizza divina." },
  { id: "s023", category: "Comida", name: "Russ & Daughters", emoji: "🐟", desc: "Salmao defumado, cream cheese, bagel no Lower East Side desde 1914.", price: "$$", lat: 40.7220, lng: -73.9876, time: "1h", link: "https://www.russanddaughters.com", petFriendly: false, publicBathroom: false, rep: "Lendario. O bagel com lox e cream cheese aqui e o melhor do mundo." },
  { id: "s024", category: "Comida", name: "Levain Bakery", emoji: "🍪", desc: "O cookie de chocolate mais famoso de NY. Enorme, cremoso e quente.", price: "$", lat: 40.7812, lng: -73.9803, time: "30min", link: "https://levainbakery.com", petFriendly: false, publicBathroom: false, rep: "O cookie mais famoso de NYC. Quente, cremoso e enorme." },
  { id: "s025", category: "Comida", name: "Peter Luger Steak House", emoji: "🥩", desc: "A churrascaria mais famosa de NY, em Williamsburg desde 1887. So aceita dinheiro.", price: "$$$", lat: 40.7099, lng: -73.9625, time: "2h", link: "https://peterluger.com", petFriendly: false, publicBathroom: true, rep: "A melhor churrascaria dos EUA. Reserve meses antes. So cash. Porterhouse e epico." },
  { id: "s026", category: "Natureza", name: "Staten Island Ferry", emoji: "⛴️", desc: "Balsa gratuita com vista frontal da Estatua da Liberdade.", price: "gratis", lat: 40.6437, lng: -74.0735, time: "1h", petFriendly: true, publicBathroom: true, rep: "A melhor vista gratuita de NYC. Muitos turistas nao sabem que e de graca." },
  { id: "s027", category: "Natureza", name: "Rockaway Beach", emoji: "🏄", desc: "Praia em Queens acessivel de metro. Boa pra surfe e com bares na orla.", price: "gratis", lat: 40.5843, lng: -73.8351, time: "dia inteiro", petFriendly: true, publicBathroom: true, rep: "A praia urbana mais legal dos EUA. Chope gelado, areia e metro de volta." },
  { id: "s028", category: "Natureza", name: "The Cloisters", emoji: "🏰", desc: "Museu de arte medieval dentro de um mosteiro reconstruido no norte de Manhattan.", price: "$$", lat: 40.8648, lng: -73.9317, time: "2h", link: "https://www.metmuseum.org/visit/met-cloisters", petFriendly: false, publicBathroom: true, rep: "Surreal e magnifico. Parece que voce saiu de NYC completamente." },
  { id: "s029", category: "Entretenimento", name: "Ver um show na Broadway", emoji: "🎭", desc: "Um classico que nao pode faltar. A experiencia mais nova-iorquina que existe.", price: "$$$", lat: 40.7590, lng: -73.9845, time: "3h+", link: "https://www.broadway.com", petFriendly: false, publicBathroom: true, rep: "Obrigatorio em NYC. TKTS na Times Square tem ingressos com ate 50% de desconto." },
  { id: "s030", category: "Entretenimento", name: "Comedy Cellar", emoji: "😂", desc: "O clube de stand-up mais lendario de NY no Village.", price: "$$", lat: 40.7302, lng: -74.0005, time: "2h", link: "https://www.comedycellar.com", petFriendly: false, publicBathroom: true, rep: "Dave Chappelle e Louis CK aparecem sem aviso. A melhor noite de NY por $30." },
  { id: "s031", category: "Entretenimento", name: "Sleep No More", emoji: "🎭", desc: "Peca imersiva de teatro noir onde voce vaga por um hotel de 5 andares.", price: "$$$", lat: 40.7467, lng: -74.0014, time: "3h+", link: "https://www.sleepnomorenyc.com", petFriendly: false, publicBathroom: true, rep: "Uma das experiencias mais unicas do mundo. Ninguem sai igual." },
  { id: "s032", category: "Entretenimento", name: "Brooklyn Mirage", emoji: "🎧", desc: "O maior venue de musica eletronica dos EUA, em Queens.", price: "$$", lat: 40.6985, lng: -73.9318, time: "3h+", link: "https://www.avant-gardner.com", petFriendly: false, publicBathroom: true, rep: "O melhor venue de eletronico dos EUA. Producao incrivel e line-ups de outro nivel." },
  { id: "s033", category: "Entretenimento", name: "Karaoke em Koreatown", emoji: "🎤", desc: "32nd St. Karaoke privativo (norebang) disponivel ate de madrugada.", price: "$$", lat: 40.7484, lng: -73.9878, time: "2h", petFriendly: false, publicBathroom: true, rep: "Norebang privativo e muito melhor que karaoke comum." },
  { id: "s034", category: "Monumentos", name: "Estatua da Liberdade", emoji: "🗽", desc: "Balsa de Battery Park pra Liberty Island. Reserve com antecedencia pra subir.", price: "$$", lat: 40.6892, lng: -74.0445, time: "3h+", link: "https://www.nps.gov/stli", petFriendly: false, publicBathroom: true, rep: "Reserve para subir na coroa com meses de antecedencia. O pedestal ja vale muito." },
  { id: "s035", category: "Monumentos", name: "Grand Central Terminal", emoji: "🚂", desc: "A estacao de trem mais bela do mundo com teto estrelado e o Whispering Gallery.", price: "gratis", lat: 40.7527, lng: -73.9772, time: "30min", petFriendly: false, publicBathroom: true, rep: "Arquitetura de tirar o folego. O Whispering Gallery e magico." },
  { id: "s036", category: "Monumentos", name: "Washington Square Park", emoji: "🎨", desc: "O parque mais vivo de Manhattan com musicos, xadrez e skatistas.", price: "gratis", lat: 40.7308, lng: -74.0002, time: "1h", petFriendly: true, publicBathroom: true, rep: "O coracao do Greenwich Village. Musicos incriveis e energia incomparavel." },
  { id: "s037", category: "Monumentos", name: "Little Island", emoji: "🌺", desc: "Parque flutuante no Hudson River no Meatpacking, inaugurado em 2021.", price: "gratis", lat: 40.7438, lng: -74.0094, time: "1h", link: "https://littleisland.org", petFriendly: true, publicBathroom: true, rep: "O projeto de parque mais bonito do seculo em NYC." },
  { id: "s038", category: "Monumentos", name: "Flatiron Building", emoji: "🏢", desc: "O predio em formato de ferro de passar roupa. Recentemente reaberto apos reforma.", price: "gratis", lat: 40.7411, lng: -73.9897, time: "30min", petFriendly: true, publicBathroom: false, rep: "Icone arquitetonico de NYC. O Madison Square Park do lado e otimo pra piquenique." },
  { id: "d001", category: "Dispensaries", name: "Housing Works Cannabis", emoji: "🌿", desc: "O primeiro dispensario com fins sociais de NY, em Soho. Ambiente sofisticado.", price: "$$", lat: 40.7243, lng: -74.0030, time: "30min", link: "https://housingworkscannabis.com", petFriendly: false, publicBathroom: false, rep: "O melhor dispensario de NYC. Ambiente unico, missao social e produtos excelentes." },
  { id: "d002", category: "Dispensaries", name: "The Travel Agency", emoji: "✈️", desc: "Dispensario tematico de viagem em Manhattan. Visual unico e atendimento impecavel.", price: "$$", lat: 40.7589, lng: -73.9851, time: "30min", petFriendly: false, publicBathroom: false, rep: "O mais instagramavel de todos. Conceito criativo e selecao excelente." },
  { id: "d003", category: "Dispensaries", name: "Gotham", emoji: "🦇", desc: "Dispensario premium no Midtown com enfase em educacao do consumidor.", price: "$$", lat: 40.7549, lng: -73.9840, time: "30min", petFriendly: false, publicBathroom: false, rep: "Elegante e sofisticado. Equipe extremamente bem treinada." },
  { id: "d004", category: "Dispensaries", name: "Smacked Village", emoji: "🌱", desc: "Dispensario bem avaliado no West Village com ambiente aconchegante.", price: "$$", lat: 40.7335, lng: -74.0030, time: "30min", petFriendly: false, publicBathroom: false, rep: "Favorito dos moradores do West Village. Ambiente intimista e selecao de qualidade." },
  { id: "d005", category: "Dispensaries", name: "Terp Bros", emoji: "🍃", desc: "Um dos primeiros dispensarios licenciados de NY no Bronx.", price: "$", lat: 40.8448, lng: -73.8648, time: "30min", petFriendly: false, publicBathroom: false, rep: "Pioneiro licenciado do Bronx. Precos justos e conexao com a comunidade local." },
  { id: "dt001", category: "Daytrips", name: "Cold Spring, NY", emoji: "🏔️", desc: "Cidade historica as margens do Hudson River com trilhas, antiquarios e restaurantes.", price: "$", lat: 41.4209, lng: -73.9557, time: "dia inteiro", link: "https://coldspringny.gov", petFriendly: true, publicBathroom: true, rep: "Um dos melhores daytrips de NYC. Metro-North de Grand Central, 1h20. Trilha Breakneck Ridge e epica." },
  { id: "dt002", category: "Daytrips", name: "Hudson, NY", emoji: "🎨", desc: "Cidade de arte e antiquarios com restaurantes excelentes e arquitetura vitoriana.", price: "$$", lat: 42.2529, lng: -73.7935, time: "dia inteiro", petFriendly: true, publicBathroom: true, rep: "A cidade mais charmosa do Hudson Valley. Warren Street e uma galeria a ceu aberto." },
  { id: "dt003", category: "Daytrips", name: "Princeton, NJ", emoji: "🎓", desc: "Campus universitario historico com museu de arte de classe mundial. 1h de trem.", price: "$", lat: 40.3573, lng: -74.6672, time: "dia inteiro", petFriendly: true, publicBathroom: true, rep: "Campus lindo para passear. O Princeton University Art Museum e de graca e incrivel." },
  { id: "dt004", category: "Daytrips", name: "Fire Island, NY", emoji: "🏝️", desc: "Ilha sem carros no Atlantico com praias paradisiacas e comunidade LGBTQ+ vibrante.", price: "$$", lat: 40.6318, lng: -73.1271, time: "dia inteiro", petFriendly: false, publicBathroom: true, rep: "Praia mais bonita proximo a NYC. Cherry Grove e The Pines sao incriveis no verao." },
  { id: "dt005", category: "Daytrips", name: "Catskills, NY", emoji: "🌲", desc: "Montanhas com cachoeiras, trilhas e cidades artisticas a 2h de NYC.", price: "$$", lat: 42.0987, lng: -74.2179, time: "dia inteiro", petFriendly: true, publicBathroom: true, rep: "O destino favorito dos nova-iorquinos. Cachoeira Kaaterskill e espetacular." },
  { id: "dt006", category: "Daytrips", name: "Asbury Park, NJ", emoji: "🎸", desc: "Cidade costeira vibrante com cena musical, boardwalk historico e bares incriveis.", price: "$", lat: 40.2204, lng: -74.0121, time: "dia inteiro", petFriendly: true, publicBathroom: true, rep: "A cidade mais cool de NJ. Cena musical incrivel e o Stone Pony e lendario." },
  { id: "dt007", category: "Daytrips", name: "Philadelphia, PA", emoji: "🔔", desc: "Cidade historica com Liberty Bell, Reading Terminal Market e restaurantes incriveis.", price: "$$", lat: 39.9526, lng: -75.1652, time: "dia inteiro", petFriendly: true, publicBathroom: true, rep: "A 1h15 de trem. O cheesesteak e o Reading Terminal Market sao imperdíveis." },
  { id: "dt008", category: "Daytrips", name: "Ski - Mountain Creek, NJ", emoji: "⛷️", desc: "Resort de ski mais proximo de NYC, a menos de 1h de carro em Vernon, NJ.", price: "$$$", lat: 41.1812, lng: -74.5099, time: "dia inteiro", link: "https://mountaincreek.com", petFriendly: false, publicBathroom: true, rep: "Menor que resorts de Vermont mas acessivel e divertido. Otimo para iniciantes." },
  { id: "dt009", category: "Daytrips", name: "Long Beach, NY", emoji: "🌊", desc: "A praia mais acessivel de NYC via LIRR, com boardwalk e boa infraestrutura.", price: "$", lat: 40.5882, lng: -73.6585, time: "dia inteiro", petFriendly: false, publicBathroom: true, rep: "30 minutos de Penn Station. A praia mais pratica de NYC para um dia de sol." },
  { id: "dt010", category: "Daytrips", name: "Storm King Art Center", emoji: "🗿", desc: "Museu de escultura ao ar livre em 500 acres de paisagem natural no Hudson Valley.", price: "$$", lat: 41.4096, lng: -74.0046, time: "dia inteiro", link: "https://stormking.org", petFriendly: false, publicBathroom: true, rep: "Uma das experiencias artisticas mais unicas do mundo. Beleza de tirar o folego." },
];
...
const injectCSS = () => {
  ...
  style.textContent = `
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .card-hover:hover { background: #20202a !important; }
    .card-hover { transition: background 0.15s ease; }
...
function Toast({ message, type, onDone }) {
  ...
  return (
    <div style={{ position: "fixed", top: 18, right: 16, zIndex: 9999, background: bg, border: "1px solid " + border, borderRadius: 12, padding: "11px 16px", color: "#f0eeff", fontSize: 13, fontWeight: 600, boxShadow: "0 4px 20px #00000060", animation: "toastIn 0.25s ease", maxWidth: 260 }}>
      {message}
    </div>
  );
}
...
function WeatherWidget() {
  ...
  useEffect(() => {
    fetch("https://api.open-meteo.com/v1/forecast?latitude=40.7128&longitude=-74.0060&current=temperature_2m,weather_code&daily=precipitation_sum,temperature_2m_max,temperature_2m_min&temperature_unit=fahrenheit&timezone=America/New_York&forecast_days=1")
      .then(r => r.json()).then(d => {
        const code = d.current.weather_code, temp = Math.round(d.current.temperature_2m);
        const max = Math.round(d.daily.temperature_2m_max[0]), min = Math.round(d.daily.temperature_2m_min[0]);
        ...
        setW({ temp, max, min, icon, desc, outdoor: rain < 2 && code < 61 });
      }).catch(() => {});
  }, []);
  if (!w) return null;
  return (
    <div style={{ background: w.outdoor ? "#001a08" : "#1a0008", border: "1px solid " + (w.outdoor ? "#003310" : "#330010"), borderRadius: 12, padding: "10px 14px", marginBottom: 10, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div>
          <div style={{ fontSize: 15, fontWeight: 700, color: "#f0eeff" }}>{w.temp}°F <span style={{ fontSize: 12, fontWeight: 400, color: "#9090b0" }}>{w.desc}</span></div>
          <div style={{ fontSize: 11, color: "#50506a" }}>Min {w.min}° / Max {w.max}°</div>
        </div>
      </div>
...
function PlannerModal({ places, entries, onClose, addToast }) {
  ...
  const plan = async () => {
    ...
    } catch { setResult("Erro ao conectar. Verifique sua conexao e tente novamente."); }
    setLoading(false);
  };
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "#000000f0", zIndex: 300, display: "flex", alignItems: "flex-end", justifyContent: "center" }} onClick={onClose}>
      <div className="slide-in" style={{ background: "#1a1a22", borderTop: "1px solid #2a2a38", borderRadius: "20px 20px 0 0", padding: "20px 16px 40px", maxWidth: 560, width: "100%", maxHeight: "90vh", overflowY: "auto" }} onClick={e => e.stopPropagation()}>
        ...
        {step === "select" ? (
          <>
            <div style={{ fontSize: 12, color: "#9090b0", marginBottom: 12 }}>Selecione ate 8 lugares ({8 - sel.length} restantes)</div>
          ...
          <div style={{ textAlign: "center", padding: "40px 0" }}>
            <div className="pulse" style={{ fontSize: 36, marginBottom: 12 }}>🤖</div>
            <div style={{ fontSize: 13, color: "#9090b0" }}>Claude esta montando seu roteiro...</div>
          </div>
        ) : (
          <>
            <div style={{ background: "#0f0f13", borderRadius: 12, padding: "14px", marginBottom: 14, fontSize: 13, color: "#f0eeff", lineHeight: 1.7, whiteSpace: "pre-wrap", maxHeight: "52vh", overflowY: "auto" }}>{result}</div>
    ...
    <div style={{ padding: "0 16px 80px" }}>
      {visited.map((p, i) => {
        ...
        return <div key={p.id} className="fade-up">
          {showMonth && <div style={{ fontSize: 10, color: "#50506a", letterSpacing: "0.14em", marginTop: i > 0 ? 18 : 0, marginBottom: 10 }}>{month !== "sem-data" ? new Date(month + "-01").toLocaleDateString("pt-BR", { month: "long", year: "numeric" }).toUpperCase() : "SEM DATA"}</div>}
          <div style={{ display: "flex", gap: 12, marginBottom: 10, background: "#1a1a22", borderRadius: 14, padding: "12px", border: "1px solid #2a2a38" }}>
            <div style={{ width: 3, borderRadius: 2, background: meta.color, flexShrink: 0 }} />
            {fp ? <img src={fp} alt="" style={{ width: 56, height: 56, borderRadius: 8, objectFit: "cover", flexShrink: 0 }} /> : <div style={{ width: 56, height: 56, borderRadius: 8, background: meta.color + "20", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, flexShrink: 0 }}>{p.emoji}</div>}
...
function CuradoriaTab({ places, lists, onSaveLists, onSelectPlace }) {
  ...
  const create = () => { if (!name.trim()) return; onSaveLists([...lists, { id: "l" + Date.now(), name: name.trim(), emoji, desc: desc.trim(), placeIds: [] }]); setName(""); setEmoji("📋"); setDesc(""); setShowCreate(false); };
  const del = id => onSaveLists(lists.filter(l => l.id !== id));
  ...
  return (
    <div style={{ padding: "0 16px 80px" }}>
      ...
      {!lists.length && !showCreate && <div style={{ textAlign: "center", padding: "40px 0", color: "#50506a" }}><div style={{ fontSize: 32, marginBottom: 8 }}>📋</div><div style={{ fontSize: 13 }}>Crie curadorias para organizar e compartilhar seus favoritos!</div></div>}
      {lists.map(list => (
        <div key={list.id} style={{ background: "#1a1a22", border: "1px solid #2a2a38", borderRadius: 14, marginBottom: 12, overflow: "hidden" }}>
          <div style={{ padding: "14px", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <div><div style={{ fontSize: 15, fontWeight: 600, color: "#f0eeff" }}>{list.emoji} {list.name}</div>{list.desc && <div style={{ fontSize: 12, color: "#50506a", marginTop: 2 }}>{list.desc}</div>}<div style={{ fontSize: 11, color: "#50506a", marginTop: 4 }}>{list.placeIds.length} lugares</div></div>
            <div style={{ display: "flex", gap: 6 }}>
              <button onClick={() => setPickingFor(pickingFor === list.id ? null : list.id)} style={{ padding: "5px 10px", background: pickingFor === list.id ? "#ff336620" : "#0f0f13", border: "1px solid " + (pickingFor === list.id ? "#ff3366" : "#2a2a38"), borderRadius: 8, color: pickingFor === list.id ? "#ff3366" : "#9090b0", fontSize: 12, cursor: "pointer" }}>{pickingFor === list.id ? "Fechar" : "+ Add"}</button>
          ...
          {list.placeIds.length > 0 && <div style={{ padding: "0 14px 14px", display: "flex", flexWrap: "wrap", gap: 6 }}>
            {list.placeIds.map(pid => { const p = places.find(x => x.id === pid); if (!p) return null; return <div key={pid} onClick={() => onSelectPlace(p)} style={{ display: "flex", alignItems: "center", gap: 6, padding: "5px 10px", background: "#0f0f13", border: "1px solid #2a2a38", borderRadius: 20, cursor: "pointer" }}><span style={{ fontSize: 13 }}>{p.emoji}</span><span style={{ fontSize: 12, color: "#f0eeff" }}>{p.name}</span><span onClick={ev => { ev.stopPropagation(); toggle(list.id, pid); }} style={{ fontSize: 12, color: "#50506a", cursor: "pointer", marginLeft: 2 }}>×</span></div>; })}
          </div>}
          {pickingFor === list.id && <div style={{ borderTop: "1px solid #2a2a38", padding: "10px 14px", maxHeight: 200, overflowY: "auto" }}>
            {places.filter(p => !list.placeIds.includes(p.id)).map(p => <div key={p.id} onClick={() => toggle(list.id, p.id)} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 0", borderBottom: "1px solid #2a2a3850", cursor: "pointer" }}><span style={{ fontSize: 16 }}>{p.emoji}</span><span style={{ fontSize: 13, color: "#f0eeff", flex: 1 }}>{p.name}</span><span style={{ fontSize: 11, color: "#50506a" }}>{p.category}</span></div>)}
          </div>}
        </div>
      ))}
    </div>
...
function NearbyPlaces({ place, places, entries, onSelect }) {
  ...
  const nearby = places.filter(p => p.id !== place.id && p.lat && p.lng && (entries[p.id] || {}).status !== "fui").sort((a, b) => dist(place, a) - dist(place, b)).slice(0, 3);
  if (!nearby.length) return null;
  return <div style={{ marginBottom: 16 }}>
    <div style={{ fontSize: 10, color: "#50506a", letterSpacing: "0.12em", marginBottom: 8 }}>LUGARES PROXIMOS</div>
    {nearby.map(p => { const meta = CAT_META[p.category] || { color: "#ff3366" }; return <div key={p.id} onClick={() => onSelect(p)} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 10px", background: "#0f0f13", border: "1px solid #2a2a38", borderRadius: 10, marginBottom: 6, cursor: "pointer" }}><span style={{ fontSize: 18 }}>{p.emoji}</span><div style={{ flex: 1 }}><div style={{ fontSize: 13, color: "#f0eeff" }}>{p.name}</div><div style={{ fontSize: 11, color: "#50506a" }}>{p.category}</div></div><span style={{ fontSize: 10, color: meta.color, background: meta.color + "20", borderRadius: 6, padding: "2px 6px" }}>{PRICE_EMOJI[p.price] || "?"}</span></div>; })}
  </div>;
}
...
function DetailModal({ place, entry, places, entries, onClose, onSave, onDelete, onSelectNearby, addToast }) {
  ...
  const handleSave = async () => {
    setSaving(true);
    await onSave({ status, note, date, photos, stars, thumb, vibes, price, who, link, petFriendly, publicBathroom });
    setSaving(false); addToast("Salvo!", "success");
  };
  const handleDelete = async () => { await onDelete(); addToast("Removido!", "success"); };
  return (
    <div style={{ position: "fixed", inset: 0, background: "#000000f0", zIndex: 300, display: "flex", alignItems: "flex-end", justifyContent: "center" }} onClick={onClose}>
      <div className="slide-in" style={{ background: "#1a1a22", borderTop: "1px solid #2a2a38", borderRadius: "20px 20px 0 0", padding: "20px 16px 48px", maxWidth: 560, width: "100%", maxHeight: "94vh", overflowY: "auto" }} onClick={ev => ev.stopPropagation()}>
        <div style={{ width: 36, height: 3, background: "#2a2a38", borderRadius: 2, margin: "0 auto 16px" }} />
        ...
        <NearbyPlaces place={place} places={places} entries={entries} onSelect={p => { onClose(); setTimeout(() => onSelectNearby(p), 150); }} />
        <button onClick={handleSave} disabled={saving} style={{ width: "100%", padding: "14px", background: saving ? "#2a2a38" : "#ff3366", border: "none", borderRadius: 12, color: saving ? "#50506a" : "#fff", fontSize: 14, fontWeight: 700, cursor: saving ? "default" : "pointer", marginBottom: 10, transition: "all 0.2s", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
          {saving ? <><span className="pulse">●</span> Salvando...</> : "Salvar"}
        </button>
...
function AddModal({ onClose, onAdd, addToast }) {
  ...
  const handle = async () => {
    ...
    await onAdd({ id: "u" + Date.now(), name: name.trim(), desc: desc.trim(), emoji, category, price, time, link, custom: true });
    addToast(name + " adicionado!", "success"); setSaving(false); onClose();
  };
  return (
    <div style={{ position: "fixed", inset: 0, background: "#000000f0", zIndex: 300, display: "flex", alignItems: "flex-end", justifyContent: "center" }} onClick={onClose}>
      <div className="slide-in" style={{ background: "#1a1a22", borderTop: "1px solid #2a2a38", borderRadius: "20px 20px 0 0", padding: "20px 16px 48px", maxWidth: 560, width: "100%", maxHeight: "85vh", overflowY: "auto" }} onClick={ev => ev.stopPropagation()}>
        <div style={{ width: 36, height: 3, background: "#2a2a38", borderRadius: 2, margin: "0 auto 16px" }} />
...
function ShareModal({ places, entries, onClose, addToast }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "#000000f0", zIndex: 300, display: "flex", alignItems: "flex-end", justifyContent: "center" }} onClick={onClose}>
      <div className="slide-in" style={{ background: "#1a1a22", borderTop: "1px solid #2a2a38", borderRadius: "20px 20px 0 0", padding: "20px 16px 40px", maxWidth: 560, width: "100%", maxHeight: "80vh", overflowY: "auto" }} onClick={ev => ev.stopPropagation()}>
        <div style={{ width: 36, height: 3, background: "#2a2a38", borderRadius: 2, margin: "0 auto 16px" }} />
...
export default function App() {
  ...
  const activeFiltersCount = [filterVibe, filterPrice, filterStars > 0, filterThumb, filterPet, filterBathroom].filter(Boolean).length;
  ...
  const filteredPlaces = places.filter(p => {
    ...
    return searchOk && catOk && statusOk && vibeOk && priceOk && starsOk && thumbOk && petOk && bathOk;
  }).sort((a, b) => {
  ...
  const TABS = [["list", "Lista"], ["map", "Mapa"], ["history", "Historico"], ["curadoria", "Curadoria"]];

  if (loading) return (
    <div style={{ minHeight: "100vh", background: "#0f0f13", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ textAlign: "center" }}><div style={{ fontSize: 48, marginBottom: 12 }}>🗽</div><div className="pulse" style={{ fontSize: 11, color: "#50506a", letterSpacing: "0.2em" }}>NYC BUCKET LIST</div></div>
    </div>
  );
        ...
        <div style={{ maxWidth: 600, margin: "0 auto", padding: "14px 16px 0" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
            <div onClick={() => window.location.reload()} style={{ cursor: "pointer" }}>
              <div style={{ fontSize: 11, color: "#50506a", letterSpacing: "0.18em", marginBottom: 1 }}>GUI & GABRIEL {syncing && <span className="pulse" style={{ color: "#ff3366" }}>· SALVANDO</span>}</div>
          ...
          <div style={{ display: "flex", gap: 0, background: "#1a1a22", borderRadius: 10, padding: 3, border: "1px solid #2a2a38", marginBottom: 10 }}>
            {TABS.map(([key, label]) => <button key={key} onClick={() => setTab(key)} style={{ flex: 1, padding: "7px 4px", borderRadius: 8, background: tab === key ? "#ff3366" : "none", border: "none", color: tab === key ? "#fff" : "#50506a", fontSize: 12, cursor: "pointer", fontWeight: tab === key ? 600 : 400, transition: "all 0.15s" }}>{label}</button>)}
          </div>
          ...
          {tab === "list" && <>
            ...
            <div style={{ display: "flex", gap: 5, marginBottom: 8, overflowX: "auto", scrollbarWidth: "none" }}>
              {[["todos","Todos"],["quero","♥ Quero"],["fui","✓ Fui"],["skip","− Skip"]].map(([key,label]) => <button key={key} onClick={() => setActiveFilter(activeFilter === key && key !== "todos" ? "todos" : key)} className="pill" style={{ padding: "5px 12px", borderRadius: 20, background: activeFilter === key ? "#ff3366" : "#1a1a22", border: "1px solid " + (activeFilter === key ? "#ff3366" : "#2a2a38"), color: activeFilter === key ? "#fff" : "#50506a", fontSize: 12, whiteSpace: "nowrap" }}>{label}</button>)}
              <button onClick={() => setShowFilters(!showFilters)} className="pill" style={{ padding: "5px 12px", borderRadius: 20, background: activeFiltersCount > 0 ? "#ffd60020" : "#1a1a22", border: "1px solid " + (activeFiltersCount > 0 ? "#ffd600" : "#2a2a38"), color: activeFiltersCount > 0 ? "#ffd600" : "#50506a", fontSize: 12, whiteSpace: "nowrap" }}>{activeFiltersCount > 0 ? "Filtros (" + activeFiltersCount + ")" : "Filtros"}</button>
            ...
            {showFilters && <div style={{ background: "#1a1a22", border: "1px solid #2a2a38", borderRadius: 12, padding: "12px", marginBottom: 8 }}>
              ...
              <div style={{ marginBottom: 10 }}><div style={{ fontSize: 10, color: "#50506a", letterSpacing: "0.12em", marginBottom: 6 }}>POLEGAR</div><div style={{ display: "flex", gap: 6 }}>{[["up","👍 Recomendados"],["down","👎 Nao curtiram"]].map(([key,label]) => <button key={key} onClick={() => setFilterThumb(filterThumb === key ? null : key)} className="pill" style={{ flex: 1, padding: "7px", borderRadius: 8, background: filterThumb === key ? "#ff336620" : "#0f0f13", border: "1px solid " + (filterThumb === key ? "#ff3366" : "#2a2a38"), color: filterThumb === key ? "#ff3366" : "#50506a", fontSize: 12 }}>{label}</button>)}</div></div>
              <div style={{ marginBottom: activeFiltersCount > 0 ? 10 : 0 }}><div style={{ fontSize: 10, color: "#50506a", letterSpacing: "0.12em", marginBottom: 6 }}>FACILIDADES</div><div style={{ display: "flex", gap: 6 }}><button onClick={() => setFilterPet(!filterPet)} className="pill" style={{ flex: 1, padding: "7px", borderRadius: 8, background: filterPet ? "#4ade8020" : "#0f0f13", border: "1px solid " + (filterPet ? "#4ade80" : "#2a2a38"), color: filterPet ? "#4ade80" : "#50506a", fontSize: 12 }}>🐾 Pet friendly</button><button onClick={() => setFilterBathroom(!filterBathroom)} className="pill" style={{ flex: 1, padding: "7px", borderRadius: 8, background: filterBathroom ? "#60a5fa20" : "#0f0f13", border: "1px solid " + (filterBathroom ? "#60a5fa" : "#2a2a38"), color: filterBathroom ? "#60a5fa" : "#50506a", fontSize: 12 }}>🚻 Banheiro</button></div></div>
              {activeFiltersCount > 0 && <button onClick={() => { setFilterVibe(null); setFilterPrice(null); setFilterStars(0); setFilterThumb(null); setFilterPet(false); setFilterBathroom(false); }} style={{ width: "100%", padding: "7px", background: "none", border: "1px solid #2a2a38", borderRadius: 8, color: "#50506a", fontSize: 12, cursor: "pointer" }}>Limpar filtros</button>}
            </div>}
            <div style={{ display: "flex", gap: 5, overflowX: "auto", scrollbarWidth: "none", paddingBottom: 10 }}>
              {["Todos", ...CATEGORIES].map(cat => { const meta = CAT_META[cat]; const active = activeCategory === cat; return <button key={cat} onClick={() => setActiveCategory(activeCategory === cat && cat !== "Todos" ? "Todos" : cat)} className="pill" style={{ padding: "4px 10px", borderRadius: 20, background: active ? (meta ? meta.color : "#ff3366") + "20" : "#1a1a22", border: "1px solid " + (active ? (meta ? meta.color : "#ff3366") + "60" : "#2a2a38"), color: active ? (meta ? meta.color : "#ff3366") : "#50506a", fontSize: 10, whiteSpace: "nowrap", letterSpacing: "0.04em" }}>{cat}</button>; })}
            </div>
          </>}
        </div>
      </div>
      ...
      <div style={{ maxWidth: 600, margin: "0 auto", padding: "10px 16px 100px" }}>
        ...
        {tab === "list" && <>
          ...
          {filteredPlaces.map(place => {
            ...
            return (
              <div key={place.id} className="card-hover" onClick={() => setSelected(place)} style={{ background: "#1a1a22", border: "1px solid " + (status === "fui" ? meta.color + "40" : "#2a2a38"), borderRadius: 12, marginBottom: 8, padding: "12px 14px", cursor: "pointer", opacity: status === "skip" ? 0.3 : 1, display: "flex", gap: 12 }}>
