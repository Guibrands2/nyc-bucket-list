...
const CAT_META = {
  ...
  "Compras":          { color: "#0369a1" },
  "Bairros":          { color: "#dc2626" },
  "Comida":           { color: "#d97706" },
  "Mercados & Delis": { color: "#b45309" },
  "Dispensaries":     { color: "#15803d" },
  "Daytrips":         { color: "#475569" },
};
...
const INITIAL_PLACES = [
  ...
  { id: "t007", category: "Museus", name: "Museum of Broadway", emoji: "🎭", desc: "Tres andares com figurinos de Hamilton, Phantom, Rent e Wicked. Na Times Square.", price: "$$", lat: 40.7580, lng: -73.9855, time: "2h", link: "https://www.themuseumofbroadway.com", petFriendly: false, publicBathroom: true, season: "sempre", rep: "Essencial para fas de musicais. Interativo e muito bem curado." },
  ...
  { id: "t020", category: "Natureza", name: "The High Line", emoji: "🌿", desc: "Parque linear suspenso numa ferrovia desativada no West Side.", price: "gratis", lat: 40.7480, lng: -74.0048, time: "2h", link: "https://www.thehighline.org", petFriendly: true, publicBathroom: true, season: "primavera", rep: "Um dos melhores projetos urbanos do seculo. Arte, jardins e vistas unicas." },
  { id: "pr001", category: "Praias", name: "Coney Island", emoji: "🎡", desc: "Praia iconica com o parque Luna Park e o cachorro-quente do Nathan's Famous.", price: "$", lat: 40.5755, lng: -73.9707, time: "dia inteiro", petFriendly: true, publicBathroom: true, season: "verao", rep: "Nostalgia pura. Melhor no verao. O Nathan's Famous e uma instituicao americana." },
  { id: "pr002", category: "Praias", name: "Rockaway Beach", emoji: "🏄", desc: "Praia em Queens acessivel de metro. Boa pra surfe e com bares na orla.", price: "gratis", lat: 40.5843, lng: -73.8351, time: "dia inteiro", petFriendly: true, publicBathroom: true, season: "verao", rep: "A praia urbana mais legal dos EUA." },
  { id: "pr003", category: "Praias", name: "Long Beach, NY", emoji: "🌊", desc: "A praia mais acessivel de NYC via LIRR, com boardwalk e boa infraestrutura.", price: "$", lat: 40.5882, lng: -73.6585, time: "dia inteiro", petFriendly: false, publicBathroom: true, season: "verao", rep: "30 minutos de Penn Station. A praia mais pratica de NYC." },
  { id: "pr004", category: "Praias", name: "Brighton Beach", emoji: "🇺🇦", desc: "Praia russa em Brooklyn com mercados, restaurantes sovieticos e atmosfera unica.", price: "gratis", lat: 40.5779, lng: -73.9612, time: "3h+", petFriendly: true, publicBathroom: true, season: "verao", rep: "Uma volta ao mundo sem sair de Brooklyn. O boardwalk ate Coney Island e incrivel." },
  { id: "pr005", category: "Praias", name: "Jacob Riis Park", emoji: "🏖️", desc: "Praia preservada no Queens com atmosfera vintage e menos turista que Coney Island.", price: "gratis", lat: 40.5618, lng: -73.8904, time: "dia inteiro", petFriendly: true, publicBathroom: true, season: "verao", rep: "A praia favorita dos nova-iorquinos que sabem. Mais tranquila e bonita." },
  { id: "pr006", category: "Praias", name: "Sandy Hook, NJ", emoji: "🦅", desc: "Peninsula pristina em NJ com praias federais, trilhas e vista de Manhattan.", price: "$", lat: 40.4643, lng: -74.0094, time: "dia inteiro", petFriendly: true, publicBathroom: true, season: "verao", rep: "A praia mais bonita da regiao. Vale o ferry de Manhattan." },
  { id: "pr007", category: "Praias", name: "Fire Island, NY", emoji: "🏝️", desc: "Ilha sem carros no Atlantico com praias paradisiacas e comunidade LGBTQ+ vibrante.", price: "$$", lat: 40.6318, lng: -73.1271, time: "dia inteiro", petFriendly: false, publicBathroom: true, season: "verao", rep: "Praia mais bonita proximo a NYC. Cherry Grove e The Pines sao incriveis." },
  { id: "md001", category: "Mercados & Delis", name: "Smorgasburg", emoji: "🍜", desc: "Maior mercado de comida ao ar livre dos EUA, todo sabado em Williamsburg.", price: "$", lat: 40.7223, lng: -73.9572, time: "2h", link: "https://www.smorgasburg.com", petFriendly: true, publicBathroom: true, season: "verao", rep: "O melhor mercado de comida dos EUA. Chega cedo e leva cash." },
  { id: "md002", category: "Mercados & Delis", name: "Chelsea Market", emoji: "🥐", desc: "Mercado gourmet coberto numa antiga fabrica de biscoitos no Meatpacking.", price: "$$", lat: 40.7424, lng: -74.0048, time: "2h", link: "https://www.chelseamarket.com", petFriendly: false, publicBathroom: true, season: "sempre", rep: "Perfeito para almocar. A Lobster Place e Los Tacos No. 1 sao obrigatorios." },
  { id: "md003", category: "Mercados & Delis", name: "Katz's Delicatessen", emoji: "🥪", desc: "O deli mais famoso de NY, desde 1888. O sanduiche de pastrami e lendario.", price: "$$", lat: 40.7223, lng: -73.9874, time: "1h", link: "https://katzsdelicatessen.com", petFriendly: false, publicBathroom: true, season: "sempre", rep: "Uma instituicao. O pastrami e transcendental. Caro mas vale cada centavo." },
  { id: "md004", category: "Mercados & Delis", name: "Russ & Daughters", emoji: "🐟", desc: "Salmao defumado, cream cheese e bagel no Lower East Side desde 1914.", price: "$$", lat: 40.7220, lng: -73.9876, time: "1h", link: "https://www.russanddaughters.com", petFriendly: false, publicBathroom: false, season: "sempre", rep: "Lendario. O bagel com lox e cream cheese aqui e o melhor do mundo." },
  { id: "md005", category: "Mercados & Delis", name: "Essex Market", emoji: "🏪", desc: "Mercado gourmet moderno no Lower East Side, com bancas de comida do mundo todo.", price: "$$", lat: 40.7183, lng: -73.9860, time: "1h", petFriendly: false, publicBathroom: true, season: "sempre", rep: "O substituto do mercado original do LES. Moderno e diverso." },
  { id: "md006", category: "Mercados & Delis", name: "Union Square Greenmarket", emoji: "🥬", desc: "Mercado de produtores locais todo sabado e quarta em Union Square.", price: "$", lat: 40.7359, lng: -73.9906, time: "1h", petFriendly: true, publicBathroom: false, season: "sempre", rep: "O melhor mercado de agricultores de NYC. Flores, queijos e mel incriveis." },
  { id: "md007", category: "Mercados & Delis", name: "Zabar's", emoji: "🧀", desc: "Deli gourmet lendario no Upper West Side desde 1934. Queijos, defumados e delicatessen.", price: "$$", lat: 40.7844, lng: -73.9830, time: "1h", link: "https://zabars.com", petFriendly: false, publicBathroom: false, season: "sempre", rep: "Uma instituicao nova-iorquina. Os queijos importados e o cafe sao incriveis." },
  { id: "md008", category: "Mercados & Delis", name: "Barney Greengrass", emoji: "🥚", desc: "O rei do esturjao desde 1908 no Upper West Side. Brunch lendario.", price: "$$", lat: 40.7851, lng: -73.9804, time: "1h", petFriendly: false, publicBathroom: false, season: "sempre", rep: "Cafe da manha mais famoso do Upper West Side. As fatias de salmao sao divinas." },
  { id: "md009", category: "Mercados & Delis", name: "Astor Wines & Spirits", emoji: "🍷", desc: "Uma das melhores adegas de NYC, no East Village. Selecao enorme e precos justos.", price: "$$", lat: 40.7284, lng: -73.9899, time: "30min", link: "https://astorwines.com", petFriendly: false, publicBathroom: false, season: "sempre", rep: "A melhor loja de vinhos e spirits de NYC. Staff incrivelmente bem informado." },
  { id: "md010", category: "Mercados & Delis", name: "Park Avenue Liquor Shop", emoji: "🥃", desc: "Loja especializada em whisky com uma das maiores selecoes de bourbon dos EUA.", price: "$$$", lat: 40.7512, lng: -73.9779, time: "30min", link: "https://parkavenueli.com", petFriendly: false, publicBathroom: false, season: "sempre", rep: "Paraiso para fas de whisky. Raridades e edicoes limitadas que nao encontra em outro lugar." },
  { id: "md011", category: "Mercados & Delis", name: "DeKalb Market Hall", emoji: "🍱", desc: "Food hall no subsolo do City Point em Brooklyn com 40 bancas de comida.", price: "$", lat: 40.6908, lng: -73.9832, time: "1h", petFriendly: false, publicBathroom: true, season: "sempre", rep: "O melhor food hall de Brooklyn. Diverso, barato e delicioso." },
  { id: "md012", category: "Mercados & Delis", name: "Brooklyn Flea", emoji: "🛺", desc: "Mercado de pulgas e vintage aos fins de semana. Comida, antiguidades e artesanato.", price: "$", lat: 40.7223, lng: -73.9572, time: "2h", link: "https://brooklynflea.com", petFriendly: true, publicBathroom: false, season: "verao", rep: "O mercado de pulgas mais cool de NYC. Achados incriveis e comida otima." },
  ...
  { id: "t030", category: "Entretenimento", name: "Bares Speakeasy", emoji: "🥃", desc: "Bares secretos escondidos atras de cafeterias e cabines telefonicas.", price: "$$", lat: 40.7282, lng: -74.0076, time: "2h", petFriendly: false, publicBathroom: true, season: "sempre", rep: "PDT e Please Don't Tell sao os mais famosos." },
  { id: "t031", category: "Entretenimento", name: "Brooklyn Mirage", emoji: "🎧", desc: "O maior venue de musica eletronica dos EUA, em Queens.", price: "$$", lat: 40.6985, lng: -73.9318, time: "3h+", link: "https://www.avant-gardner.com", petFriendly: false, publicBathroom: true, season: "verao", rep: "O melhor venue de eletronico dos EUA." },
  { id: "t032", category: "Entretenimento", name: "Comedy Cellar", emoji: "😂", desc: "O clube de stand-up mais lendario de NY no Village.", price: "$$", lat: 40.7302, lng: -74.0005, time: "2h", link: "https://www.comedycellar.com", petFriendly: false, publicBathroom: true, season: "sempre", rep: "Dave Chappelle e Louis CK aparecem sem aviso." },
  ...
  { id: "t034", category: "Entretenimento", name: "Karaoke em Koreatown", emoji: "🎤", desc: "32nd St. Karaoke privativo (norebang) disponivel ate de madrugada.", price: "$$", lat: 40.7484, lng: -73.9878, time: "2h", petFriendly: false, publicBathroom: true, season: "sempre", rep: "Norebang privativo e muito melhor que karaoke comum." },
  ...
  { id: "t037", category: "Comida", name: "Di Fara Pizza", emoji: "🍕", desc: "A pizza mais famosa de Brooklyn, feita a mao pelo mesmo dono ha decadas.", price: "$", lat: 40.6249, lng: -73.9612, time: "1h", petFriendly: false, publicBathroom: false, season: "sempre", rep: "Peregrinacao obrigatoria para fas de pizza." },
  { id: "t038", category: "Comida", name: "Levain Bakery", emoji: "🍪", desc: "O cookie de chocolate mais famoso de NY. Enorme, cremoso e quente.", price: "$", lat: 40.7812, lng: -73.9803, time: "30min", link: "https://levainbakery.com", petFriendly: false, publicBathroom: false, season: "sempre", rep: "O cookie mais famoso de NYC." },
  ...
  { id: "t040", category: "Comida", name: "Momofuku Noodle Bar", emoji: "🍜", desc: "O restaurante original do David Chang no East Village. Ramen e buns lendarios.", price: "$$", lat: 40.7285, lng: -73.9842, time: "1h", link: "https://momofuku.com", petFriendly: false, publicBathroom: false, season: "sempre", rep: "Imprescindivel para fas de gastronomia. Os pork buns sao icônicos." },
  { id: "t041", category: "Compras", name: "American Dream Outlet", emoji: "🛍️", desc: "O maior outlet de NJ com parque de diversoes, pista de esqui indoor e aquario.", price: "$$", lat: 40.8135, lng: -74.0669, time: "dia inteiro", link: "https://www.americandream.com", petFriendly: false, publicBathroom: true, season: "sempre", rep: "Muito alem de um outlet." },
  ...
  { id: "s007", category: "Bairros", name: "Greenpoint, Brooklyn", emoji: "🇵🇱", desc: "Bairro polones com cafes independentes, galerias e vista da skyline.", price: "$", lat: 40.7242, lng: -73.9480, time: "2h", petFriendly: true, publicBathroom: false, season: "sempre", rep: "O bairro mais charmoso de Brooklyn." },
  { id: "s008", category: "Bairros", name: "Red Hook, Brooklyn", emoji: "⚓", desc: "Antigo bairro industrial na beira d'agua com galerias e cervejarias.", price: "$", lat: 40.6759, lng: -74.0109, time: "2h", petFriendly: true, publicBathroom: false, season: "verao", rep: "Off the beaten path mas vale muito." },
  { id: "s009", category: "Bairros", name: "Jackson Heights, Queens", emoji: "🇮🇳", desc: "Bairro mais diverso do mundo. Culinaria sul-asiatica, latina e muito mais.", price: "$", lat: 40.7498, lng: -73.8831, time: "2h", petFriendly: true, publicBathroom: false, season: "sempre", rep: "Uma volta ao mundo em alguns quarteiroes." },
  { id: "s010", category: "Museus", name: "Whitney Museum", emoji: "🎨", desc: "Arte americana contemporanea no Meatpacking District com terraco incrivel.", price: "$$", lat: 40.7396, lng: -74.0089, time: "2h", link: "https://whitney.org", petFriendly: false, publicBathroom: true, season: "sempre", rep: "Colecao americana extraordinaria." },
  { id: "s011", category: "Museus", name: "The Met", emoji: "🏛️", desc: "Um dos maiores museus do mundo. Egito, armaduras medievais, impressionismo.", price: "$$", lat: 40.7794, lng: -73.9632, time: "dia inteiro", link: "https://www.metmuseum.org", petFriendly: false, publicBathroom: true, season: "sempre", rep: "Poderia passar uma semana e nao ver tudo." },
  { id: "s012", category: "Museus", name: "Guggenheim", emoji: "🌀", desc: "O predio em espiral de Frank Lloyd Wright ja e arte. Colecao de arte moderna.", price: "$$", lat: 40.7830, lng: -73.9590, time: "2h", link: "https://www.guggenheim.org", petFriendly: false, publicBathroom: true, season: "sempre", rep: "O edificio sozinho ja justifica a visita." },
  { id: "s013", category: "Museus", name: "Tenement Museum", emoji: "🏚️", desc: "Visita guiada a apartamentos de imigrantes preservados do seculo XIX.", price: "$$", lat: 40.7183, lng: -73.9898, time: "2h", link: "https://www.tenement.org", petFriendly: false, publicBathroom: false, season: "sempre", rep: "Uma das experiencias mais tocantes de NYC." },
  { id: "s014", category: "Museus", name: "Brooklyn Museum", emoji: "🖼️", desc: "Segundo maior museu de arte dos EUA com colecao egipcia impressionante.", price: "$$", lat: 40.6712, lng: -73.9636, time: "3h+", link: "https://www.brooklynmuseum.org", petFriendly: false, publicBathroom: true, season: "sempre", rep: "Incrivelmente subestimado. A colecao egipcia rivaliza com o Met." },
  { id: "s015", category: "Museus", name: "Frick Collection", emoji: "🎻", desc: "Mansao do seculo XIX transformada em museu com Vermeer, Rembrandt e Renoir.", price: "$$", lat: 40.7713, lng: -73.9672, time: "2h", link: "https://www.frick.org", petFriendly: false, publicBathroom: true, season: "sempre", rep: "Experiencia unica de ver arte numa mansao." },
  { id: "s016", category: "Monumentos", name: "Estatua da Liberdade", emoji: "🗽", desc: "Balsa de Battery Park pra Liberty Island. Reserve com antecedencia pra subir.", price: "$$", lat: 40.6892, lng: -74.0445, time: "3h+", link: "https://www.nps.gov/stli", petFriendly: false, publicBathroom: true, season: "sempre", rep: "Reserve para subir na coroa com meses de antecedencia." },
  ...
  { id: "s018", category: "Monumentos", name: "Washington Square Park", emoji: "🎨", desc: "O parque mais vivo de Manhattan com musicos, xadrez e skatistas.", price: "gratis", lat: 40.7308, lng: -74.0002, time: "1h", petFriendly: true, publicBathroom: true, season: "primavera", rep: "O coracao do Greenwich Village." },
  { id: "s019", category: "Monumentos", name: "Little Island", emoji: "🌺", desc: "Parque flutuante no Hudson River no Meatpacking, inaugurado em 2021.", price: "gratis", lat: 40.7438, lng: -74.0094, time: "1h", link: "https://littleisland.org", petFriendly: true, publicBathroom: true, season: "primavera", rep: "O projeto de parque mais bonito do seculo em NYC." },
  { id: "s020", category: "Monumentos", name: "Flatiron Building", emoji: "🏢", desc: "O predio em formato de ferro de passar roupa. Recentemente reaberto apos reforma.", price: "gratis", lat: 40.7411, lng: -73.9897, time: "30min", petFriendly: true, publicBathroom: false, season: "sempre", rep: "Icone arquitetonico de NYC." },
  { id: "s021", category: "Natureza", name: "Staten Island Ferry", emoji: "⛴️", desc: "Balsa gratuita com vista frontal da Estatua da Liberdade.", price: "gratis", lat: 40.6437, lng: -74.0735, time: "1h", petFriendly: true, publicBathroom: true, season: "sempre", rep: "A melhor vista gratuita de NYC." },
  { id: "s022", category: "Natureza", name: "The Cloisters", emoji: "🏰", desc: "Museu de arte medieval dentro de um mosteiro reconstruido no norte de Manhattan.", price: "$$", lat: 40.8648, lng: -73.9317, time: "2h", link: "https://www.metmuseum.org/visit/met-cloisters", petFriendly: false, publicBathroom: true, season: "sempre", rep: "Surreal e magnifico. Parece que voce saiu de NYC completamente." },
  ...
  { id: "dt004", category: "Daytrips", name: "Catskills, NY", emoji: "🌲", desc: "Montanhas com cachoeiras, trilhas e cidades artisticas a 2h de NYC.", price: "$$", lat: 42.0987, lng: -74.2179, time: "dia inteiro", petFriendly: true, publicBathroom: true, season: "outono", rep: "O destino favorito dos nova-iorquinos." },
  { id: "dt005", category: "Daytrips", name: "Asbury Park, NJ", emoji: "🎸", desc: "Cidade costeira vibrante com cena musical, boardwalk historico e bares incriveis.", price: "$", lat: 40.2204, lng: -74.0121, time: "dia inteiro", petFriendly: true, publicBathroom: true, season: "verao", rep: "A cidade mais cool de NJ." },
  { id: "dt006", category: "Daytrips", name: "Philadelphia, PA", emoji: "🔔", desc: "Cidade historica com Liberty Bell, Reading Terminal Market e restaurantes.", price: "$$", lat: 39.9526, lng: -75.1652, time: "dia inteiro", petFriendly: true, publicBathroom: true, season: "sempre", rep: "A 1h15 de trem. O cheesesteak e o Reading Terminal Market sao imperdíveis." },
  { id: "dt007", category: "Daytrips", name: "Ski - Mountain Creek, NJ", emoji: "⛷️", desc: "Resort de ski mais proximo de NYC, a menos de 1h de carro.", price: "$$$", lat: 41.1812, lng: -74.5099, time: "dia inteiro", link: "https://mountaincreek.com", petFriendly: false, publicBathroom: true, season: "inverno", rep: "Menor que resorts de Vermont mas acessivel e divertido." },
...
async function walkingMins(fromLat, fromLng, toLat, toLng) {
  try {
    ...
    if (d.routes?.[0]) return Math.round(d.routes[0].duration/60);
  } catch {}
  return Math.round(haversineKm(fromLat,fromLng,toLat,toLng)/5*60);
}

function citymapperUrl(place) {
  if (!place.lat || !place.lng) return null;
  return "https://citymapper.com/directions?endcoord="+place.lat+"%2C"+place.lng+"&endname="+encodeURIComponent(place.name)+"&endaddress="+encodeURIComponent("New York, NY");
}
...
const Icons = {
  ...
  Walk: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="4" r="2"/><path d="M12 6l-2 6 4 2-1 6"/><path d="M10 12l-3 3"/></svg>,
...
function HdrBtn({ icon, label, onClick, active }) {
  return (
    <button onClick={onClick} className="hdr-btn" style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:3, padding:"6px 10px", background:"#1a1a22", border:"1px solid "+(active?"#ff3366":"#2a2a38"), borderRadius:10, color:active?"#ff3366":"#9090b0", cursor:"pointer", minWidth:52 }}>
      {icon}
      <span style={{ fontSize:9, letterSpacing:"0.04em", whiteSpace:"nowrap" }}>{label}</span>
    </button>
  );
}
...
function Toast({ message, type, onDone, onUndo }) {
  ...
  return (
    <div style={{ position:"fixed", top:18, right:16, zIndex:9999, background:bg, border:"1px solid "+border, borderRadius:12, padding:"11px 14px", color:"#f0eeff", fontSize:13, fontWeight:600, boxShadow:"0 4px 20px #00000060", animation:"toastIn 0.25s ease", maxWidth:290, display:"flex", alignItems:"center", gap:10 }}>
      <span style={{ flex:1 }}>{message}</span>
      {onUndo && <button onClick={()=>{onUndo();onDone();}} style={{ background:"#ffffff20", border:"none", borderRadius:8, padding:"4px 10px", color:"#fff", fontSize:12, cursor:"pointer", whiteSpace:"nowrap" }}>Desfazer</button>}
    </div>
  );
}
  ...
  useEffect(()=>{
    fetch("https://api.open-meteo.com/v1/forecast?latitude=40.7128&longitude=-74.0060&current=temperature_2m,weather_code&daily=precipitation_sum,temperature_2m_max,temperature_2m_min&temperature_unit=celsius&timezone=America/New_York&forecast_days=1")
      .then(r=>r.json()).then(d=>{
        ...
        if(code>=71){icon="❄️";desc="Nevando";}else if(code>=61){icon="🌧️";desc="Chovendo";}else if(code>=51){icon="🌦️";desc="Garoa";}else if(code>=45){icon="🌫️";desc="Nebuloso";}else if(code>=3){icon="☁️";desc="Nublado";}else if(code>=1){icon="⛅";desc="Parcialmente nublado";}
  ...
  return (
    <div style={{ background:w.outdoor?"#001a08":"#1a0008", border:"1px solid "+(w.outdoor?"#003310":"#330010"), borderRadius:12, padding:"10px 14px", marginBottom:10, display:"flex", alignItems:"center", justifyContent:"space-between" }}>
      <div style={{ display:"flex", alignItems:"center", gap:10 }}>
        ...
        <div>
          <div style={{ fontSize:15, fontWeight:700, color:"#f0eeff" }}>{w.tempC}°C <span style={{ fontSize:12, color:"#9090b0" }}>/ {w.tempF}°F · {w.desc}</span></div>
          <div style={{ fontSize:11, color:"#50506a" }}>Min {w.minC}°C / Max {w.maxC}°C</div>
        </div>
      </div>
      <div style={{ fontSize:11, fontWeight:600, color:w.outdoor?"#00e676":"#ff3366", background:(w.outdoor?"#00e676":"#ff3366")+"20", borderRadius:20, padding:"4px 10px" }}>{w.outdoor?"Bom pra sair!":"Indoor hoje"}</div>
    </div>
  );
}
...
function MapTab({ places, entries, onSelect }) {
  ...
  useEffect(()=>{
    ...
    if(!inst.current){inst.current=window.L.map(mapRef.current,{center:[40.730,-73.990],zoom:12});window.L.tileLayer("https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png",{attribution:"CartoDB"}).addTo(inst.current);}
    ...
    places.forEach(p=>{
      ...
      const m=window.L.marker([p.lat,p.lng],{icon}).addTo(inst.current);m.on("click",()=>onSelect(p));markers.current.push(m);
    });
  ...
  return <div style={{ padding:"0 16px 16px" }}><div style={{ fontSize:11, color:"#50506a", marginBottom:8, letterSpacing:"0.08em" }}>TOQUE EM UM PIN PARA DETALHES</div><div style={{ borderRadius:14, overflow:"hidden", border:"1px solid #2a2a38" }}><div ref={mapRef} style={{ height:"62vh", width:"100%" }}/></div></div>;
}
...
function TimelineTab({ places, entries, onSelect }) {
  ...
  if(!visited.length) return <div style={{ textAlign:"center", padding:"60px 20px", color:"#50506a" }}><div style={{ fontSize:40, marginBottom:12 }}>📖</div><div style={{ fontSize:14 }}>Nenhum lugar visitado ainda.</div></div>;
  let lastMonth="";
  return (
    <div style={{ padding:"0 16px 80px" }}>
      {visited.map((p,i)=>{
        const meta=CAT_META[p.category]||{color:"#ff3366"}, month=p.entry.date?p.entry.date.slice(0,7):"sem-data", showMonth=month!==lastMonth; lastMonth=month;
        const fp=p.entry.photos?p.entry.photos[0]:null;
        return <div key={p.id} className="fade-up">
          {showMonth&&<div style={{ display:"flex", alignItems:"center", gap:10, marginTop:i>0?24:0, marginBottom:14 }}><div style={{ height:1, flex:1, background:"#2a2a38" }}/><div style={{ fontSize:11, color:"#50506a", letterSpacing:"0.12em", whiteSpace:"nowrap" }}>{month!=="sem-data"?new Date(month+"-01").toLocaleDateString("pt-BR",{month:"long",year:"numeric"}).toUpperCase():"SEM DATA"}</div><div style={{ height:1, flex:1, background:"#2a2a38" }}/></div>}
          <div onClick={()=>onSelect(p)} style={{ display:"flex", gap:12, marginBottom:10, background:"#1a1a22", borderRadius:14, padding:"12px", border:"1px solid #2a2a38", cursor:"pointer" }} className="card">
            <div style={{ display:"flex", flexDirection:"column", alignItems:"center" }}><div style={{ width:2, flex:1, background:meta.color+"40", minHeight:16 }}/><div style={{ width:10, height:10, borderRadius:"50%", background:meta.color, flexShrink:0 }}/><div style={{ width:2, flex:1, background:meta.color+"15", minHeight:16 }}/></div>
...
function CuradoriaTab({ places, lists, onSaveLists, onSelectPlace }) {
  ...
  const share = list => {
    ...
    navigator.clipboard.writeText(list.emoji+" "+list.name+(list.desc?"\n"+list.desc:"")+"\n\n"+lp.map(p=>p.emoji+" "+p.name).join("\n")+"\n\nApp: "+window.location.href);
  };
  ...
  if(view==="create") return (
    <div style={{ padding:"0 16px 80px" }}>
      <button onClick={()=>setView("home")} style={{ background:"none", border:"none", color:"#9090b0", fontSize:13, cursor:"pointer", marginBottom:16 }}>← Voltar</button>
      ...
      <div style={{ display:"flex", gap:10, marginBottom:10 }}>
        ...
        <input value={newName} onChange={e=>setNewName(e.target.value)} placeholder="Nome..." autoFocus style={{ flex:1, background:"#1a1a22", border:"1px solid #2a2a38", borderRadius:10, padding:"10px 14px", color:"#f0eeff", fontSize:14 }}/>
      </div>
  ...
  if(view==="edit"&&editList) return (
    <div style={{ padding:"0 16px 80px" }}>
      <button onClick={()=>setView("home")} style={{ background:"none", border:"none", color:"#9090b0", fontSize:13, cursor:"pointer", marginBottom:12 }}>← Minhas curadorias</button>
      <div style={{ background:"#1a1a22", border:"1px solid #2a2a38", borderRadius:14, padding:"14px", marginBottom:14 }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start" }}>
          <div>
            <div style={{ fontSize:18, fontWeight:700, color:"#f0eeff" }}>{editList.emoji} {editList.name}</div>
            {editList.desc&&<div style={{ fontSize:12, color:"#9090b0", marginTop:2 }}>{editList.desc}</div>}
            <div style={{ fontSize:11, color:"#50506a", marginTop:4 }}>{editList.placeIds.length} lugares</div>
          </div>
          <div style={{ display:"flex", gap:6 }}>
            <button onClick={()=>share(editList)} style={{ padding:"6px 10px", background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:8, color:"#9090b0", fontSize:12, cursor:"pointer" }}>↗ Compartilhar</button>
            <button onClick={()=>del(editList.id)} style={{ padding:"6px 8px", background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:8, color:"#9090b0", fontSize:12, cursor:"pointer" }}>🗑</button>
          </div>
        </div>
        {editList.placeIds.length>0&&<div style={{ marginTop:12, borderTop:"1px solid #2a2a38", paddingTop:10, display:"flex", flexWrap:"wrap", gap:6 }}>
          {editList.placeIds.map(pid=>{const p=places.find(x=>x.id===pid);if(!p)return null;return <div key={pid} style={{ display:"flex", alignItems:"center", gap:5, padding:"4px 10px", background:"#ff336615", border:"1px solid #ff336640", borderRadius:20 }}><span style={{ fontSize:13 }}>{p.emoji}</span><span style={{ fontSize:12, color:"#f0eeff" }}>{p.name}</span><button onClick={()=>toggle(editList.id,pid)} style={{ background:"none", border:"none", color:"#ff3366", cursor:"pointer", fontSize:14 }}>×</button></div>;})}
        </div>}
      </div>
      <div style={{ fontSize:13, color:"#9090b0", marginBottom:8 }}>Selecione lugares para adicionar:</div>
      <div style={{ position:"relative", marginBottom:10 }}>
        <input value={search} onChange={e=>setSearch(e.target.value)} placeholder="Buscar lugares..." style={{ width:"100%", background:"#1a1a22", border:"1px solid #2a2a38", borderRadius:10, padding:"9px 14px 9px 14px", color:"#f0eeff", fontSize:13 }}/>
      </div>
      <div style={{ maxHeight:"50vh", overflowY:"auto" }}>
        {filtered.map(p=>{
          const inList=editList.placeIds.includes(p.id), meta=CAT_META[p.category]||{color:"#ff3366"};
          return <div key={p.id} onClick={()=>toggle(editList.id,p.id)} style={{ display:"flex", alignItems:"center", gap:12, padding:"10px 12px", background:inList?"#ff336610":"#1a1a22", border:"1px solid "+(inList?"#ff336640":"#2a2a38"), borderRadius:10, marginBottom:6, cursor:"pointer", transition:"all 0.15s" }}>
            <span style={{ fontSize:20 }}>{p.emoji}</span>
            <div style={{ flex:1 }}><div style={{ fontSize:13, color:"#f0eeff", fontWeight:inList?600:400 }}>{p.name}</div><div style={{ fontSize:11, color:"#50506a" }}>{p.category}</div></div>
  ...
  return (
    <div style={{ padding:"0 16px 80px" }}>
      <button onClick={()=>setView("create")} style={{ width:"100%", padding:"13px", background:"#ff336615", border:"1px dashed #ff336650", borderRadius:12, color:"#ff3366", fontSize:14, cursor:"pointer", marginBottom:14, fontFamily:"inherit" }}>+ Criar nova curadoria</button>
      {!lists.length&&<div style={{ textAlign:"center", padding:"40px 0", color:"#50506a" }}><div style={{ fontSize:32, marginBottom:8 }}>📋</div><div style={{ fontSize:13 }}>Crie curadorias para organizar seus favoritos!</div><div style={{ fontSize:12, marginTop:4, color:"#3a3a50" }}>Ex: Para ir com amigos, NYC romantico, Dia de chuva</div></div>}
      {lists.map(list=>{
        const lp=list.placeIds.map(pid=>places.find(p=>p.id===pid)).filter(Boolean);
        return <div key={list.id} onClick={()=>{setEditId(list.id);setView("edit");}} style={{ background:"#1a1a22", border:"1px solid #2a2a38", borderRadius:14, marginBottom:10, padding:"14px", cursor:"pointer" }} className="card">
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:lp.length?8:0 }}>
            <div><div style={{ fontSize:15, fontWeight:600, color:"#f0eeff" }}>{list.emoji} {list.name}</div>{list.desc&&<div style={{ fontSize:12, color:"#9090b0", marginTop:2 }}>{list.desc}</div>}<div style={{ fontSize:11, color:"#50506a", marginTop:4 }}>{list.placeIds.length} lugares · toque para editar</div></div>
            <button onClick={e=>{e.stopPropagation();share(list);}} style={{ padding:"5px 10px", background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:8, color:"#9090b0", fontSize:12, cursor:"pointer" }}>↗</button>
          </div>
          {lp.length>0&&<div style={{ display:"flex", flexWrap:"wrap", gap:4 }}>
            {lp.slice(0,4).map(p=><span key={p.id} style={{ fontSize:11, color:"#9090b0", background:"#0f0f13", borderRadius:20, padding:"3px 8px" }}>{p.emoji} {p.name}</span>)}
            {lp.length>4&&<span style={{ fontSize:11, color:"#50506a", padding:"3px 8px" }}>+{lp.length-4}</span>}
          </div>}
        </div>;
      })}
    </div>
...
function NearbyInModal({ place, places, entries, onSelect }) {
  ...
  useEffect(()=>{
    ...
    const cands=places.filter(p=>p.id!==place.id&&p.lat&&p.lng&&(entries[p.id]||{}).status!=="fui").map(p=>({...p,distKm:haversineKm(place.lat,place.lng,p.lat,p.lng)})).sort((a,b)=>a.distKm-b.distKm).slice(0,4);
    setNearby(cands.map(p=>({...p,mins:null})));
    cands.forEach(async(p,i)=>{const mins=await walkingMins(place.lat,place.lng,p.lat,p.lng);setNearby(prev=>prev.map((x,j)=>j===i?{...x,mins}:x));});
  },[place.id]);
  ...
  return (
    <div style={{ marginBottom:16 }}>
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:6 }}>
        {nearby.map(p=>{
          const meta=CAT_META[p.category]||{color:"#ff3366"};
          return <div key={p.id} onClick={()=>onSelect(p)} style={{ display:"flex", alignItems:"center", gap:10, padding:"10px 12px", background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:10, cursor:"pointer" }}>
            <div style={{ width:36, height:36, borderRadius:8, background:meta.color+"18", display:"flex", alignItems:"center", justifyContent:"center", fontSize:18, flexShrink:0 }}>{p.emoji}</div>
            <div style={{ flex:1 }}><div style={{ fontSize:13, color:"#f0eeff", fontWeight:500 }}>{p.name}</div><div style={{ fontSize:11, color:"#50506a" }}>{p.category}</div></div>
            <div style={{ textAlign:"right", flexShrink:0 }}>
              {p.mins!==null?<div style={{ display:"flex", alignItems:"center", gap:4, color:"#00e676", fontSize:12, fontWeight:600 }}><Icons.Walk/>{p.mins} min</div>:<div className="pulsing" style={{ fontSize:11, color:"#50506a" }}>...</div>}
...
function CheckInModal({ place, onClose, onSave, addToast }) {
  const handle=async()=>{await onSave({status:"fui",date:new Date().toISOString().split("T")[0],who:"juntos",note:"Check-in rapido!",photos:[],stars:0,thumb:null,vibes:[],price:place.price||null,petFriendly:place.petFriendly||false,publicBathroom:place.publicBathroom||false,link:place.link||"",season:place.season||"sempre"});addToast("Check-in em "+place.name+"!","success");onClose();};
  return <div style={{ position:"fixed", inset:0, background:"#000000f0", zIndex:400, display:"flex", alignItems:"center", justifyContent:"center", padding:20 }} onClick={onClose}><div style={{ background:"#1a1a22", border:"1px solid #2a2a38", borderRadius:20, padding:"28px 24px", maxWidth:320, width:"100%", textAlign:"center" }} onClick={e=>e.stopPropagation()}><div style={{ fontSize:40, marginBottom:12 }}>{place.emoji}</div><div style={{ fontSize:17, fontWeight:700, color:"#f0eeff", marginBottom:6 }}>{place.name}</div><div style={{ fontSize:13, color:"#9090b0", marginBottom:24 }}>Marcar como visitado hoje?</div><button onClick={handle} style={{ width:"100%", padding:"14px", background:"#00e676", border:"none", borderRadius:12, color:"#000", fontSize:14, fontWeight:700, cursor:"pointer", marginBottom:10 }}>✓ Check-in agora!</button><button onClick={onClose} style={{ width:"100%", padding:"12px", background:"none", border:"1px solid #2a2a38", borderRadius:12, color:"#9090b0", fontSize:13, cursor:"pointer" }}>Cancelar</button></div></div>;
}

function NearbyDrawer({ userLat, userLng, places, entries, onSelect, onClose }) {
  const [nearby,setNearby]=useState([]);
  useEffect(()=>{
    const cands=places.filter(p=>p.lat&&p.lng&&(entries[p.id]||{}).status!=="fui").map(p=>({...p,distKm:haversineKm(userLat,userLng,p.lat,p.lng)})).filter(p=>p.distKm<3).sort((a,b)=>a.distKm-b.distKm).slice(0,10);
    setNearby(cands.map(p=>({...p,mins:null})));
    cands.forEach(async(p,i)=>{const mins=await walkingMins(userLat,userLng,p.lat,p.lng);setNearby(prev=>prev.map((x,j)=>j===i?{...x,mins}:x));});
  },[]);
  return (
    <div style={{ position:"fixed", inset:0, background:"#000000f0", zIndex:400, display:"flex", alignItems:"flex-end", justifyContent:"center" }} onClick={onClose}>
      <div className="modal" style={{ background:"#1a1a22", borderTop:"1px solid #2a2a38", borderRadius:"20px 20px 0 0", padding:"20px 16px 40px", maxWidth:560, width:"100%", maxHeight:"75vh", overflowY:"auto" }} onClick={e=>e.stopPropagation()}>
        ...
        <div style={{ fontSize:15, fontWeight:700, color:"#f0eeff", marginBottom:4 }}>Lugares proximos</div>
        <div style={{ fontSize:12, color:"#9090b0", marginBottom:14 }}>No raio de 3km · distancia a pe</div>
        {!nearby.length?<div style={{ color:"#50506a", fontSize:13, textAlign:"center", padding:"30px 0" }}>Nenhum lugar da lista a menos de 3km.</div>:
        <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
          {nearby.map(p=>{
            const meta=CAT_META[p.category]||{color:"#ff3366"};
            return <div key={p.id} onClick={()=>{onClose();setTimeout(()=>onSelect(p),150);}} style={{ display:"flex", alignItems:"center", gap:12, padding:"12px", background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:12, cursor:"pointer" }}>
              <div style={{ width:40, height:40, borderRadius:10, background:meta.color+"18", display:"flex", alignItems:"center", justifyContent:"center", fontSize:20, flexShrink:0 }}>{p.emoji}</div>
              <div style={{ flex:1 }}><div style={{ fontSize:14, color:"#f0eeff", fontWeight:600 }}>{p.name}</div><div style={{ fontSize:11, color:"#50506a", marginTop:2 }}>{p.category} · {PRICE_EMOJI[p.price]||"?"}</div></div>
              <div style={{ textAlign:"right", flexShrink:0 }}>
                {p.mins!==null?<div style={{ display:"flex", alignItems:"center", gap:4, color:"#00e676", fontSize:13, fontWeight:600 }}><Icons.Walk/>{p.mins} min</div>:<div className="pulsing" style={{ fontSize:11, color:"#50506a" }}>calc...</div>}
                <div style={{ fontSize:10, color:"#50506a", marginTop:2 }}>{p.distKm<1?(p.distKm*1000).toFixed(0)+"m":(p.distKm.toFixed(1)+"km")}</div>
              </div>
            </div>;
          })}
        </div>}
...
function PlannerChatModal({ places, entries, onClose, addToast }) {
  ...
  const send=async()=>{
    ...
    const ctx="Voce e um guia especialista em NYC. Usuario mora em Jersey City, NJ. Visitados: "+visited+". Wishlist: "+wishlist+(selNames?". Selecionados: "+selNames:"")+". Responda em portugues brasileiro, seja conciso e util.";
    try{const r=await fetch(AI_PROXY,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({messages:[{role:"user",content:ctx+"\n\nPergunta: "+userMsg}]})});const d=await r.json();setMsgs([...newMsgs,{role:"assistant",content:d.content?.[0]?.text||"Erro."}]);}catch{setMsgs([...newMsgs,{role:"assistant",content:"Erro ao conectar."}]);}
    setLoading(false);
  };

  const detectLoc=()=>{setLocLoading(true);navigator.geolocation.getCurrentPosition(async pos=>{try{const r=await fetch("https://nominatim.openstreetmap.org/reverse?lat="+pos.coords.latitude+"&lon="+pos.coords.longitude+"&format=json");const d=await r.json();setStartLoc((d.address.neighbourhood||d.address.suburb||d.address.city||"minha loc")+", "+(d.address.state||"NY"));}catch{setStartLoc(pos.coords.latitude.toFixed(4)+","+pos.coords.longitude.toFixed(4));}setLocLoading(false);},()=>setLocLoading(false));};

  const genPlan=async()=>{setShowPlan(true);setPlanLoading(true);const chosen=places.filter(p=>selected.includes(p.id));const prompt="Estou em "+startLoc+" e quero visitar em NYC: "+chosen.map(p=>p.name+" ("+p.category+", "+p.time+", "+p.price+")").join("; ")+". Monte roteiro detalhado com horarios, transporte especifico (metro/a pe), onde comer, dicas. Portugues brasileiro.";try{const r=await fetch(AI_PROXY,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({messages:[{role:"user",content:prompt}]})});const d=await r.json();setPlanResult(d.content?.[0]?.text||"Erro.");}catch{setPlanResult("Erro ao conectar.");}setPlanLoading(false);};

  const toggleSel=id=>setSelected(prev=>prev.includes(id)?prev.filter(x=>x!==id):prev.length<8?[...prev,id]:prev);

  const filtPlaces=places.filter(p=>{if(!filterQ)return true;const q=filterQ.toLowerCase();return p.name.toLowerCase().includes(q)||p.category.toLowerCase().includes(q)||(q.includes("gratis")&&p.price==="gratis");});
  ...
  if(showPlan) return (
    <div style={{ position:"fixed", inset:0, background:"#000000f0", zIndex:300, display:"flex", alignItems:"flex-end", justifyContent:"center" }} onClick={()=>setShowPlan(false)}>
      <div className="modal" style={{ background:"#1a1a22", borderTop:"1px solid #2a2a38", borderRadius:"20px 20px 0 0", padding:"20px 16px 40px", maxWidth:560, width:"100%", height:"88vh", display:"flex", flexDirection:"column" }} onClick={e=>e.stopPropagation()}>
        ...
        <div style={{ fontSize:15, fontWeight:700, color:"#f0eeff", marginBottom:2 }}>Roteiro do dia 🗓️</div>
        <div style={{ fontSize:12, color:"#9090b0", marginBottom:12 }}>Partindo de: {startLoc}</div>
      ...
      <div className="modal" style={{ background:"#1a1a22", borderTop:"1px solid #2a2a38", borderRadius:"20px 20px 0 0", maxWidth:560, width:"100%", height:"90vh", display:"flex", flexDirection:"column" }} onClick={e=>e.stopPropagation()}>
        <div style={{ padding:"14px 16px 12px", borderBottom:"1px solid #2a2a38" }}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:10 }}>
            <div><div style={{ fontSize:15, fontWeight:700, color:"#f0eeff" }}>Guia & Planejador NYC</div><div style={{ fontSize:11, color:"#9090b0" }}>Converse, selecione e gere um roteiro</div></div>
          ...
          <div style={{ display:"flex", gap:8 }}>
            ...
            <button onClick={detectLoc} style={{ padding:"7px 10px", background:"#ff336615", border:"1px solid #ff336640", borderRadius:8, color:"#ff3366", fontSize:11, cursor:"pointer" }}>{locLoading?"...":"📍 GPS"}</button>
          </div>
        </div>
        ...
        <div style={{ flex:1, overflowY:"auto", padding:"12px 16px" }}>
          {msgs.map((m,i)=>(
            <div key={i} style={{ marginBottom:10, display:"flex", justifyContent:m.role==="user"?"flex-end":"flex-start" }}>
              {m.role==="assistant"&&<div style={{ width:28, height:28, borderRadius:"50%", background:"#ff336620", border:"1px solid #ff336640", display:"flex", alignItems:"center", justifyContent:"center", fontSize:14, flexShrink:0, marginRight:8, alignSelf:"flex-end" }}>🤖</div>}
          ...
          {loading&&<div style={{ display:"flex", alignItems:"flex-end", gap:8, marginBottom:10 }}><div style={{ width:28, height:28, borderRadius:"50%", background:"#ff336620", border:"1px solid #ff336640", display:"flex", alignItems:"center", justifyContent:"center", fontSize:14 }}>🤖</div><div style={{ padding:"10px 14px", borderRadius:"18px 18px 18px 4px", background:"#0f0f13", border:"1px solid #2a2a38" }}><span className="pulsing" style={{ color:"#9090b0", fontSize:13 }}>digitando...</span></div></div>}
          <div ref={bottomRef}/>
        </div>

        <div style={{ borderTop:"1px solid #2a2a38", padding:"10px 16px 16px" }}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:6 }}>
            <div style={{ fontSize:10, color:"#50506a", letterSpacing:"0.1em" }}>LUGARES ({selected.length}/8 selecionados)</div>
            {selected.length>0&&<button onClick={()=>setSelected([])} style={{ background:"none", border:"none", color:"#50506a", fontSize:11, cursor:"pointer" }}>Limpar</button>}
          </div>
          <input value={filterQ} onChange={e=>setFilterQ(e.target.value)} placeholder="Filtrar: Brooklyn, gratis, museu..." style={{ width:"100%", background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:8, padding:"6px 10px", color:"#f0eeff", fontSize:12, marginBottom:8 }}/>
          <div style={{ display:"flex", gap:5, overflowX:"auto", scrollbarWidth:"none", paddingBottom:8 }}>
            {filtPlaces.map(p=>{
              const on=selected.includes(p.id), meta=CAT_META[p.category]||{color:"#ff3366"};
              return <div key={p.id} onClick={()=>toggleSel(p.id)} style={{ display:"flex", alignItems:"center", gap:5, padding:"5px 10px", background:on?meta.color+"20":"#0f0f13", border:"1px solid "+(on?meta.color:"#2a2a38"), borderRadius:20, cursor:"pointer", flexShrink:0, transition:"all 0.12s" }}>
          ...
          {selected.length>0&&<button onClick={genPlan} style={{ width:"100%", padding:"10px", background:"#ff3366", border:"none", borderRadius:10, color:"#fff", fontSize:13, fontWeight:600, cursor:"pointer", marginBottom:8 }}>Gerar roteiro ({selected.length} lugares) →</button>}
          <div style={{ display:"flex", gap:8 }}>
...
function EditNameModal({ place, onClose, onSave }) {
  ...
  const handle=()=>{if(!name.trim())return;onSave({...place,name:name.trim(),emoji,desc:desc.trim()});onClose();};
  return (
    <div style={{ position:"fixed", inset:0, background:"#000000f0", zIndex:400, display:"flex", alignItems:"center", justifyContent:"center", padding:20 }} onClick={onClose}>
      <div style={{ background:"#1a1a22", border:"1px solid #2a2a38", borderRadius:16, padding:"20px", maxWidth:400, width:"100%" }} onClick={e=>e.stopPropagation()}>
        <div style={{ fontSize:15, fontWeight:700, color:"#f0eeff", marginBottom:14 }}>Editar lugar</div>
        <div style={{ display:"flex", gap:10, marginBottom:12 }}>
          ...
          <input value={name} onChange={e=>setName(e.target.value)} style={{ flex:1, background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:8, padding:"8px 12px", color:"#f0eeff", fontSize:14 }}/>
        </div>
        <textarea value={desc} onChange={e=>setDesc(e.target.value)} placeholder="Descricao..." rows={3} style={{ width:"100%", background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:8, padding:"8px 12px", color:"#f0eeff", fontSize:13, resize:"none", marginBottom:14 }}/>
        <div style={{ display:"flex", gap:8 }}>
          <button onClick={handle} style={{ flex:1, padding:"11px", background:"#ff3366", border:"none", borderRadius:10, color:"#fff", fontSize:13, fontWeight:600, cursor:"pointer" }}>Salvar</button>
          <button onClick={onClose} style={{ flex:1, padding:"11px", background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:10, color:"#9090b0", fontSize:13, cursor:"pointer" }}>Cancelar</button>
        </div>
      </div>
    </div>
  );
...
function DetailModal({ place, entry, places, entries, onClose, onSave, onDelete, onSelectNearby, onEditPlace, addToast }) {
  const e=entry||{};
  ...
  const STATUS={quero:{label:"Quero ir",icon:"♡",sel:"♥",color:"#4da6ff"},fui:{label:"Ja fui!",icon:"○",sel:"✓",color:"#00e676"}};
  const mapsUrl="https://www.google.com/maps/search/?api=1&query="+encodeURIComponent(place.name+" New York");
  const cityUrl=citymapperUrl(place);
  ...
  const handleDelete=async()=>{await onDelete();addToast("Removido!","error");};
  return (
    <>
      <div style={{ position:"fixed", inset:0, background:"#000000f0", zIndex:300, display:"flex", alignItems:"flex-end", justifyContent:"center" }} onClick={onClose}>
        <div className="modal" style={{ background:"#1a1a22", borderTop:"1px solid #2a2a38", borderRadius:"20px 20px 0 0", padding:"20px 16px 48px", maxWidth:560, width:"100%", maxHeight:"94vh", overflowY:"auto" }} onClick={ev=>ev.stopPropagation()}>
          ...
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:14 }}>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:6 }}>
                ...
                <div>
                  <div style={{ display:"flex", alignItems:"center", gap:6 }}>
                    ...
                    <button onClick={()=>setShowEdit(true)} style={{ background:"none", border:"none", color:"#50506a", cursor:"pointer", padding:"2px", display:"flex" }}><Icons.Edit/></button>
                  </div>
            ...
            <div style={{ display:"flex", gap:5 }}>
              <a href={mapsUrl} target="_blank" rel="noreferrer" title="Google Maps" style={{ background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:8, width:34, height:34, color:"#9090b0", display:"flex", alignItems:"center", justifyContent:"center", textDecoration:"none" }}><Icons.Map/></a>
          ...
          {status==="fui"&&<>
            <div style={{ marginBottom:14 }}><div style={{ fontSize:10, color:"#50506a", letterSpacing:"0.12em", marginBottom:8 }}>QUEM FOI?</div><div style={{ display:"flex", gap:8 }}>{WHO_OPTIONS.map(w=><button key={w} onClick={()=>setWho(w)} style={{ flex:1, padding:"10px 4px", borderRadius:10, background:who===w?"#ffd60018":"#0f0f13", border:"1px solid "+(who===w?"#ffd60060":"#2a2a38"), color:who===w?"#ffd600":"#50506a", fontSize:13, cursor:"pointer", transition:"all 0.15s" }}><div>{WHO_EMOJI[w]}</div><div style={{ fontSize:10, marginTop:3 }}>{WHO_LABELS[w]}</div></button>)}</div></div>
            <div style={{ marginBottom:14 }}><div style={{ fontSize:10, color:"#50506a", letterSpacing:"0.12em", marginBottom:8 }}>QUANDO?</div><input type="date" value={date} onChange={ev=>setDate(ev.target.value)} style={{ width:"100%", background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:10, padding:"10px 14px", color:"#f0eeff", fontSize:14 }}/></div>
          </>}
          <div style={{ marginBottom:14 }}><div style={{ fontSize:10, color:"#50506a", letterSpacing:"0.12em", marginBottom:8 }}>PRECO</div><div style={{ display:"flex", gap:6 }}>{PRICE_LEVELS.map(p=><button key={p} onClick={()=>setPrice(price===p?null:p)} style={{ flex:1, padding:"8px 4px", borderRadius:10, background:price===p?"#ffd60018":"#0f0f13", border:"1px solid "+(price===p?"#ffd60060":"#2a2a38"), color:price===p?"#ffd600":"#50506a", fontSize:13, cursor:"pointer", transition:"all 0.15s" }}>{PRICE_EMOJI[p]}</button>)}</div></div>
          <div style={{ marginBottom:14 }}><div style={{ fontSize:10, color:"#50506a", letterSpacing:"0.12em", marginBottom:8 }}>MELHOR EPOCA</div><div style={{ display:"flex", gap:5, flexWrap:"wrap" }}>{SEASONS.map(s=><button key={s} onClick={()=>setSeason(s)} style={{ padding:"6px 10px", borderRadius:20, background:season===s?"#ffd60018":"#0f0f13", border:"1px solid "+(season===s?"#ffd60060":"#2a2a38"), color:season===s?"#ffd600":"#50506a", fontSize:12, cursor:"pointer", transition:"all 0.15s" }}>{SEASON_EMOJI[s]} {SEASON_LABELS[s]}</button>)}</div></div>
          <div style={{ marginBottom:14 }}><div style={{ fontSize:10, color:"#50506a", letterSpacing:"0.12em", marginBottom:8 }}>VIBE</div><div style={{ display:"flex", flexWrap:"wrap", gap:6 }}>{VIBES.map(v=><button key={v} onClick={()=>setVibes(prev=>prev.includes(v)?prev.filter(x=>x!==v):[...prev,v])} style={{ padding:"6px 12px", borderRadius:20, background:vibes.includes(v)?"#ff336618":"#0f0f13", border:"1px solid "+(vibes.includes(v)?"#ff336660":"#2a2a38"), color:vibes.includes(v)?"#ff3366":"#50506a", fontSize:12, cursor:"pointer", transition:"all 0.15s" }}>{VIBE_EMOJI[v]} {VIBE_LABELS[v]}</button>)}</div></div>
          <div style={{ marginBottom:14 }}><div style={{ fontSize:10, color:"#50506a", letterSpacing:"0.12em", marginBottom:8 }}>FACILIDADES</div><div style={{ display:"flex", gap:8 }}><button onClick={()=>setPetFriendly(!petFriendly)} style={{ flex:1, padding:"9px", borderRadius:10, background:petFriendly?"#4ade8018":"#0f0f13", border:"1px solid "+(petFriendly?"#4ade8060":"#2a2a38"), color:petFriendly?"#4ade80":"#50506a", fontSize:12, cursor:"pointer", transition:"all 0.15s" }}>🐾 Pet friendly</button><button onClick={()=>setPublicBathroom(!publicBathroom)} style={{ flex:1, padding:"9px", borderRadius:10, background:publicBathroom?"#60a5fa18":"#0f0f13", border:"1px solid "+(publicBathroom?"#60a5fa60":"#2a2a38"), color:publicBathroom?"#60a5fa":"#50506a", fontSize:12, cursor:"pointer", transition:"all 0.15s" }}>🚻 Banheiro</button></div></div>
          {status==="fui"&&<div style={{ marginBottom:14 }}><div style={{ fontSize:10, color:"#50506a", letterSpacing:"0.12em", marginBottom:8 }}>AVALIACAO</div><div style={{ display:"flex", gap:4, marginBottom:10 }}>{[1,2,3,4,5].map(n=><span key={n} onClick={()=>setStars(stars===n?0:n)} style={{ fontSize:26, cursor:"pointer", color:n<=stars?"#ffd600":"#50506a", transition:"color 0.1s" }}>★</span>)}</div><div style={{ display:"flex", gap:8 }}><button onClick={()=>setThumb(thumb==="up"?null:"up")} style={{ flex:1, padding:"10px", borderRadius:10, background:thumb==="up"?"#00e67620":"#0f0f13", border:"1px solid "+(thumb==="up"?"#00e676":"#2a2a38"), fontSize:20, cursor:"pointer", transition:"all 0.15s" }}>👍</button><button onClick={()=>setThumb(thumb==="down"?null:"down")} style={{ flex:1, padding:"10px", borderRadius:10, background:thumb==="down"?"#ff336620":"#0f0f13", border:"1px solid "+(thumb==="down"?"#ff3366":"#2a2a38"), fontSize:20, cursor:"pointer", transition:"all 0.15s" }}>👎</button></div></div>}
          <div style={{ marginBottom:14 }}><div style={{ fontSize:10, color:"#50506a", letterSpacing:"0.12em", marginBottom:8 }}>{status==="fui"?"COMO FOI?":"NOTAS"}</div><textarea value={note} onChange={ev=>setNote(ev.target.value)} placeholder={status==="fui"?"Adoramos! A fila valeu...":"Lembrete, dica, horario..."} rows={3} style={{ width:"100%", background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:10, padding:"10px 14px", color:"#f0eeff", fontSize:14, resize:"none" }}/></div>
          <div style={{ marginBottom:14 }}><div style={{ fontSize:10, color:"#50506a", letterSpacing:"0.12em", marginBottom:8 }}>LINK (ingresso, evento, site)</div><input value={link} onChange={ev=>setLink(ev.target.value)} placeholder="https://..." style={{ width:"100%", background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:10, padding:"10px 14px", color:"#f0eeff", fontSize:13 }}/></div>
          <div style={{ marginBottom:14 }}><div style={{ fontSize:10, color:"#50506a", letterSpacing:"0.12em", marginBottom:8 }}>FOTOS (ate 4)</div><PhotoGallery photos={photos} onChange={setPhotos}/></div>
          <NearbyInModal place={place} places={places} entries={entries} onSelect={p=>{onClose();setTimeout(()=>onSelectNearby(p),150);}}/>
          <button onClick={handleSave} disabled={saving} style={{ width:"100%", padding:"14px", background:saving?"#2a2a38":"#ff3366", border:"none", borderRadius:12, color:saving?"#50506a":"#fff", fontSize:14, fontWeight:700, cursor:saving?"default":"pointer", marginBottom:10, transition:"all 0.2s", display:"flex", alignItems:"center", justifyContent:"center", gap:8 }}>{saving?<><span className="pulsing">●</span> Salvando...</>:"Salvar"}</button>
          {confirmDel?<div style={{ display:"flex", gap:8 }}><button onClick={()=>setConfirmDel(false)} style={{ flex:1, padding:"11px", background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:10, color:"#9090b0", fontSize:13, cursor:"pointer" }}>Cancelar</button><button onClick={handleDelete} style={{ flex:1, padding:"11px", background:"#4a0000", border:"1px solid #883333", borderRadius:10, color:"#ff8888", fontSize:13, cursor:"pointer" }}>Confirmar</button></div>:<button onClick={()=>setConfirmDel(true)} style={{ width:"100%", padding:"11px", background:"none", border:"1px solid #2a2a38", borderRadius:10, color:"#50506a", fontSize:13, cursor:"pointer" }}>Remover lugar</button>}
        </div>
      </div>
  ...
  return (
    <div style={{ position:"fixed", inset:0, background:"#000000f0", zIndex:300, display:"flex", alignItems:"flex-end", justifyContent:"center" }} onClick={onClose}>
      <div className="modal" style={{ background:"#1a1a22", borderTop:"1px solid #2a2a38", borderRadius:"20px 20px 0 0", padding:"20px 16px 48px", maxWidth:560, width:"100%", maxHeight:"85vh", overflowY:"auto" }} onClick={ev=>ev.stopPropagation()}>
        ...
        <div style={{ display:"flex", gap:10, marginBottom:12 }}><input value={emoji} onChange={ev=>setEmoji(ev.target.value)} maxLength={2} style={{ width:50, background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:8, padding:"8px", color:"#f0eeff", fontSize:22, textAlign:"center" }}/><input value={name} onChange={ev=>setName(ev.target.value)} placeholder="Nome do lugar..." style={{ flex:1, background:"#0f0f13", border:"1px solid #2a2a38", borderRadius:8, padding:"8px 12px", color:"#f0eeff", fontSize:14 }}/></div>
        <div style={{ display:"flex", gap:8, marginBottom:12 }}><select value={category} onChange={ev=>setCategory(ev.target.value)} style={{ flex:1, background:"#1a1a22", border:"1px solid #2a2a38", borderRadius:8, padding:"8px 10px", color:"#f0eeff", fontSize:13 }}>{CATEGORIES.map(c=><option key={c} value={c}>{c}</option>)}</select><div style={{ display:"flex", gap:4 }}>{PRICE_LEVELS.map(p=><button key={p} onClick={()=>setPrice(p)} style={{ padding:"8px", borderRadius:8, background:price===p?"#ff336620":"#0f0f13", border:"1px solid "+(price===p?"#ff3366":"#2a2a38"), color:price===p?"#ff3366":"#50506a", fontSize:12, cursor:"pointer" }}>{PRICE_EMOJI[p]}</button>)}</div></div>
    ...
    <div style={{ position:"fixed", inset:0, background:"#000000f0", zIndex:300, display:"flex", alignItems:"flex-end", justifyContent:"center" }} onClick={onClose}>
      <div className="modal" style={{ background:"#1a1a22", borderTop:"1px solid #2a2a38", borderRadius:"20px 20px 0 0", padding:"20px 16px 40px", maxWidth:560, width:"100%", maxHeight:"80vh", overflowY:"auto" }} onClick={ev=>ev.stopPropagation()}>
        ...
        {!recs.length?<div style={{ color:"#50506a", fontSize:13, textAlign:"center", padding:"20px 0" }}>Avalie lugares primeiro!</div>:<>
          ...
          <button onClick={()=>copy("Nossos favoritos em NYC 🗽\n\n"+recs.map(p=>{const e=entries[p.id]||{};return p.emoji+" "+p.name+(e.stars?" "+"★".repeat(e.stars):"");}).join("\n")+"\n\n"+url)} style={{ width:"100%", padding:"13px", background:"#ff3366", border:"none", borderRadius:10, color:"#fff", fontSize:14, fontWeight:700, cursor:"pointer", marginBottom:8 }}>Copiar lista pra WhatsApp</button>
...
export default function App() {
  ...
  const handleEditPlace = async updated => {
    setCustomEdits(prev => ({...prev, [updated.id]: {name:updated.name, emoji:updated.emoji, desc:updated.desc}}));
    setPlaces(prev => prev.map(p => p.id===updated.id ? updated : p));
    if (selected?.id === updated.id) setSelected(updated);
    await set(ref(db,"customEdits/"+updated.id), {name:updated.name, emoji:updated.emoji, desc:updated.desc});
  ...
  const handleNearby = () => {
    navigator.geolocation.getCurrentPosition(pos=>{setUserLat(pos.coords.latitude);setUserLng(pos.coords.longitude);setShowNearby(true);}, ()=>addToast("Nao foi possivel obter sua localizacao","error"));
  };

  // Apply custom edits to places
  const effectivePlaces = places.map(p => customEdits[p.id] ? {...p,...customEdits[p.id]} : p);

  const toggleArr = (arr, setArr, val) => setArr(prev => prev.includes(val) ? prev.filter(x=>x!==val) : [...prev,val]);

  const activeFiltersCount = [filterVibes.length>0, filterPrices.length>0, filterSeasons.length>0, filterStars>0, filterThumb, filterPet, filterBathroom].filter(Boolean).length;
  ...
  const clearFilters=()=>{setFilterVibes([]);setFilterPrices([]);setFilterSeasons([]);setFilterStars(0);setFilterThumb(null);setFilterPet(false);setFilterBathroom(false);};

  if(loading) return <div style={{ minHeight:"100vh", background:"#0f0f13", display:"flex", alignItems:"center", justifyContent:"center" }}><div style={{ textAlign:"center" }}><div style={{ fontSize:48, marginBottom:12 }}>🗽</div><div className="pulsing" style={{ fontSize:11, color:"#50506a", letterSpacing:"0.2em" }}>NYC BUCKET LIST</div></div></div>;
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#0f0f13", color:"#f0eeff", fontFamily:"'Inter', system-ui, sans-serif" }}>
      ...
      <div style={{ background:"#0f0f13f8", backdropFilter:"blur(12px)", borderBottom:"1px solid #2a2a38", position:"sticky", top:0, zIndex:100 }}>
        <div style={{ maxWidth:600, margin:"0 auto", padding:"14px 16px 0" }}>
          ...
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:12 }}>
            ...
            <div style={{ display:"flex", gap:6 }}>
              <HdrBtn icon={<Icons.Dice/>} label="Sortear" onClick={getSurprise}/>
              <HdrBtn icon={<Icons.MapPin/>} label="Proximos" onClick={handleNearby}/>
              <HdrBtn icon={<Icons.Bot/>} label="Planejar" onClick={()=>setShowPlanner(true)}/>
              <HdrBtn icon={<Icons.Share/>} label="Compartilhar" onClick={()=>setShowShare(true)}/>
            </div>
          </div>
          ...
          <div style={{ background:"#1a1a22", border:"1px solid #2a2a38", borderRadius:12, padding:"10px 14px", marginBottom:10 }}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:6 }}>
              ...
              <div style={{ display:"flex", gap:8, alignItems:"center" }}>
                {hasAnyFilter&&filteredPlaces.length!==total&&<div style={{ fontSize:11, color:"#ffd600" }}>{filteredPlaces.length} de {total}</div>}
          ...
          {tab==="list"&&<>
            ...
            <div style={{ display:"flex", gap:5, marginBottom:8, overflowX:"auto", scrollbarWidth:"none" }}>
              {[["todos","Todos"],["quero","♥ Quero"],["fui","✓ Fui"]].map(([key,label])=><button key={key} onClick={()=>setActiveFilter(activeFilter===key&&key!=="todos"?"todos":key)} className="btn" style={{ padding:"5px 12px", borderRadius:20, background:activeFilter===key?"#ff3366":"#1a1a22", border:"1px solid "+(activeFilter===key?"#ff3366":"#2a2a38"), color:activeFilter===key?"#fff":"#50506a", fontSize:12, whiteSpace:"nowrap" }}>{label}</button>)}
            ...
            {showFilters&&<div style={{ background:"#1a1a22", border:"1px solid #2a2a38", borderRadius:12, padding:"12px", marginBottom:8 }}>
              ...
              {activeFiltersCount>0&&<button onClick={clearFilters} style={{ width:"100%", padding:"7px", background:"none", border:"1px solid #2a2a38", borderRadius:8, color:"#50506a", fontSize:12, cursor:"pointer" }}>Limpar filtros</button>}
            </div>}
      ...
      {selected&&<DetailModal place={selected} entry={entries[selected.id]} places={visiblePlaces} entries={entries} onClose={()=>setSelected(null)} onSave={async data=>{await handleSave(selected.id,data);}} onDelete={()=>handleDelete(selected.id,selected.name)} onSelectNearby={setSelected} onEditPlace={handleEditPlace} addToast={addToast}/>}
