    ...
    <div style={{ position:"fixed",inset:0,background:"#000000f0",zIndex:300,display:"flex",alignItems:"flex-end",justifyContent:"center" }} onClick={onClose}>
      <div className="modal" style={{ background:"#1a1a22",borderTop:"1px solid #2a2a38",borderRadius:"20px 20px 0 0",padding:"20px 16px 40px",maxWidth:560,width:"100%",maxHeight:"92vh",overflowY:"auto" }} onClick={e=>e.stopPropagation()}>
        ...
        <div style={{ marginBottom:14 }}>
          ...
          <div style={{ display:"flex",gap:6 }}>
            {[["indoor",isEN?"Indoor":"Indoor"],["outdoor",isEN?"Outdoor":"Outdoor"],["tanto faz",isEN?"Either":"Tanto faz"]].map(([v,l])=>CHIP(l,params.ambiente===v,()=>setP("ambiente",params.ambiente===v?null:v),"#4da6ff"))}
          </div>
        </div>
        ...
        <div style={{ marginBottom:14 }}>
          ...
          <div style={{ display:"flex",gap:6,flexWrap:"wrap" }}>
            {[["gratis",isEN?"Free only":"So gratis"],["barato","< $30"],["moderado","< $80"],["sem limite",isEN?"No limit":"Sem limite"]].map(([v,l])=>CHIP(l,params.budget===v,()=>setP("budget",params.budget===v?null:v),"#ffd600"))}
          </div>
        </div>
